...
__d("UFIActionTypes", [], (function a(b, c, d, e, f, g) {
    c.__markCompiled && c.__markCompiled();
    f.exports = {
        INSTANCE: {
        ...
        ADD_COMMENT: {
            ...
            TYPING_CHANGE: "add_comment_typing_change"
        },
        FEEDBACK: {
            FETCH_REQUEST: "feedback_fetch_request",
            FETCHED_TARGET: "feedback_fetched_target"
        },
        TRANSLATION: {
            TRANSLATE_ALL_COMPLETE: "ltg_translate_all_complete",
            HAS_TRANSLATABLE_CONTENT: "ltg_has_translatable_content",
            UPDATE_TRANSLATABLE_COMMENTS: "ltg_update_translatable_comments"
        }
    };
}), null);
__d("UFIConstants", [], (function a(b, c, d, e, f, g) {
    c.__markCompiled && c.__markCompiled();
    f.exports = {
        LikeReaction: 1,
        UFIActionType: {
...
__d('Dispatcher_DEPRECATED', ['invariant', 'monitorCodeUse'], (function a(b, c, d, e, f, g, h) {
    ...
    j.prototype.register = function(k, l) {
        l = this.__genID(l);
        this.$Dispatcher_DEPRECATED1[l] = k;
        return l;
    };
    j.prototype.unregister = function(k) {
        !this.$Dispatcher_DEPRECATED1[k] ? h(0) : void 0;
        delete this.$Dispatcher_DEPRECATED1[k];
    };
    j.prototype.waitFor = function(k) {
        !this.$Dispatcher_DEPRECATED2 ? h(0) : void 0;
        for (var l = 0; l < k.length; l++) {
            var m = k[l];
            if (this.$Dispatcher_DEPRECATED4[m]) {
                !this.$Dispatcher_DEPRECATED3[m] ? h(0) : void 0;
                continue;
            }!this.$Dispatcher_DEPRECATED1[m] ? h(0) : void 0;
            this.$Dispatcher_DEPRECATED7(m);
        }
    };
    j.prototype.dispatch = function(k) {
        !!this.$Dispatcher_DEPRECATED2 ? h(0) : void 0;
        this.$Dispatcher_DEPRECATED8(k);
        try {
            for (var l in this.$Dispatcher_DEPRECATED1) {
                if (this.$Dispatcher_DEPRECATED4[l]) continue;
                this.$Dispatcher_DEPRECATED7(l);
            }
        } finally {
    ...
    j.prototype.$Dispatcher_DEPRECATED7 = function(k) {
        this.$Dispatcher_DEPRECATED4[k] = true;
        this.__invokeCallback(k, this.$Dispatcher_DEPRECATED1[k], this.$Dispatcher_DEPRECATED6);
        this.$Dispatcher_DEPRECATED3[k] = true;
    };
    j.prototype.__invokeCallback = function(k, l, m) {
        l(m);
    };
    j.prototype.$Dispatcher_DEPRECATED8 = function(k) {
        for (var l in this.$Dispatcher_DEPRECATED1) {
            this.$Dispatcher_DEPRECATED4[l] = false;
            this.$Dispatcher_DEPRECATED3[l] = false;
        }
        this.$Dispatcher_DEPRECATED6 = k;
    ...
    j.prototype.__genID = function(k) {
        k = k || i + this.$Dispatcher_DEPRECATED5++;
        while (this.$Dispatcher_DEPRECATED1[k]) k = i + this.$Dispatcher_DEPRECATED5++;
        return k;
    };
    f.exports = j;
}), null);
...
__d('UFISharedDispatcher', ['invariant', 'ReactDispatcher_DEPRECATED', 'UFIActionTypes', 'ex'], (function a(b, c, d, e, f, g, h) {
    var i, j;
    if (c.__markCompiled) c.__markCompiled();
    ...
    m.prototype.dispatch = function(n) {
        'use strict';
        if (k(n.type, c('UFIActionTypes').INSTANCE)) {
            l(n, 'instanceID', 'contextArgs.instanceid');
        } else if (k(n.type, c('UFIActionTypes').STORY)) {
            l(n, 'ftentidentifier', 'contextArgs.ftentidentifier');
        } else if (k(n.type, c('UFIActionTypes').COMMENT)) {
            l(n, 'fbid', 'comment.fbid');
        } else throw new Error(c('ex')('Invalid UFIActionType of %s. Actions that run through ' + 'UFISharedDispatcher must have fields that are known to be unique ' + 'such as `instanceID` or `fbid`.', n.type));
...
__d('UFIInstanceAction', ['UFIActionTypes'], (function a(b, c, d, e, f, g) {
    'use strict';
    if (c.__markCompiled) c.__markCompiled();
    var h = c('UFIActionTypes').INSTANCE,
        i = {
            changeOrderingMode: function j(k, l) {
                return {
                    type: h.CHANGE_ORDER_MODE,
                    instanceID: k,
                    mode: l
                };
            },
            toggleComments: function j(k) {
                return {
                    type: h.TOGGLE_COMMENTS,
                    instanceID: k
                };
            },
            changeCommentListVisibility: function j(k, l) {
                return {
                    type: h.CHANGE_VISIBILITY,
                    instanceID: k,
                    visibility: l
                };
            },
            didRequestVODComments: function j(k) {
                return {
                    type: h.REQUESTED_VOD_COMMENTS,
                    instanceID: k
                };
            },
            didReceiveVODComments: function j(k) {
                return {
                    type: h.RECEIVED_VOD_COMMENTS,
                    instanceID: k
                };
            },
            remove: function j(k) {
...
__d('LiveTimer', ['fbt', 'csx', 'cx', 'CSS', 'DOM', 'ServerTime', 'setTimeout'], (function a(b, c, d, e, f, g, h, i, j) {
    if (c.__markCompiled) c.__markCompiled();
    var k = 1000,
        l = 60,
        m = 3600,
...
__d('UFICentralUpdates', ['Arbiter', 'BanzaiODS', 'LiveTimer', 'ShortProfiles', 'UFIConstants'], (function a(b, c, d, e, f, g) {
    ...
    function m() {
        if (!h) {
            ...
            j = {};
            k = {};
            if (Object.keys(q).length) o('feedback-updated', q);
            if (Object.keys(r).length) o('comments-updated', r);
            if (Object.keys(s).length) o('instance-updated', s);
            l.pop();
        }
    }
    ...
    var p = Object.assign(new(c('Arbiter'))(), {
        handleUpdate: function q(r, s) {
            if (Object.keys(s).length) this.synchronizeInforms(function() {
                l.push(r);
                var t = babelHelpers['extends']({
                    payloadsource: n()
                }, s);
                this.inform('update-feedback', t);
                this.inform('update-comment-lists', t);
                this.inform('update-comments', t);
                this.inform('update-actions', t);
                c('ShortProfiles').setMulti(s.profiles || {});
                if (s.servertime) c('LiveTimer').restart(s.servertime);
            }.bind(this));
        },
        didUpdateFeedback: function q(r) {
            i[r] = true;
            m();
        },
        didUpdateComment: function q(r) {
            j[r] = true;
            m();
        },
        didUpdateInstanceState: function q(r, s) {
            if (!k[r]) k[r] = {};
            k[r][s] = true;
            m();
        },
        synchronizeInforms: function q(r) {
            h++;
            try {
                r();
            } catch (s) {
...
__d('FluxStore', ['invariant', 'EventEmitter'], (function a(b, c, d, e, f, g, h) {
    ...
    function i(j) {
        ...
        this.$FluxStore1 = j.register(function(k) {
            this.__invokeOnDispatch(k);
        }.bind(this), this.__getIDForDispatcher());
    }
    i.prototype.addListener = function(j) {
        return this.__emitter.addListener(this.__changeEvent, j);
    };
    ...
    i.prototype.hasChanged = function() {
        !this.__dispatcher.isDispatching() ? h(0) : void 0;
    ...
    i.prototype.__invokeOnDispatch = function(j) {
        this.__changed = false;
        this.__onDispatch(j);
        if (this.__changed) this.__emitter.emit(this.__changeEvent);
    };
    i.prototype.__onDispatch = function(j) {
        h(0);
    };
...
__d('FluxReduceStore', ['invariant', 'FluxStore', 'abstractMethod'], (function a(b, c, d, e, f, g, h) {
    'use strict';
    var i, j;
    if (c.__markCompiled) c.__markCompiled();
    i = babelHelpers.inherits(k, c('FluxStore'));
    j = i && i.prototype;
    ...
    k.prototype.areEqual = function(l, m) {
        return l === m;
    };
    k.prototype.__invokeOnDispatch = function(l) {
        this.__changed = false;
        var m = this.$FluxReduceStore1,
            n = this.reduce(m, l);
        !(n !== undefined) ? h(0): void 0;
        if (!this.areEqual(m, n)) {
            this.$FluxReduceStore1 = n;
            this.__emitChange();
        }
        if (this.__changed) this.__emitter.emit(this.__changeEvent);
    };
...
__d('UFIOrderingModeStore', ['FluxReduceStore', 'immutable', 'UFIActionTypes', 'UFISharedDispatcher'], (function a(b, c, d, e, f, g) {
    'use strict';
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    h = babelHelpers.inherits(j, c('FluxReduceStore'));
    i = h && h.prototype;
    j.prototype.getOrderingMode = function(k, l, m, n) {
        return k.get(l) || this.$UFIOrderingModeStore1(m, n);
    };
    j.prototype.$UFIOrderingModeStore1 = function(k, l) {
    ...
    j.prototype.areEqual = function(k, l) {
        return c('immutable').is(k, l);
    };
    j.prototype.reduce = function(k, l) {
        switch (l.type) {
            case c('UFIActionTypes').INSTANCE.CHANGE_ORDER_MODE:
                return k.set(l.instanceID, l.mode);
        }
        return k;
    };
    ...
    f.exports = new j(c('UFISharedDispatcher'));
}), null);
...
__d('AbstractLink.react', ['$', 'emptyFunction', 'Bootloader', 'LinkshimHandlerConfig', 'React', 'URI'], (function a(b, c, d, e, f, g) {
    'use strict';
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    var j = new(c('URI'))('/l.php').setDomain(c('LinkshimHandlerConfig').linkshim_host);

    function k(p, q) {
        var r = new(c('URI'))(p),
            s = r.getProtocol() === 'http' ? 'http' : 'https';
        return j.setQueryData({
            u: p,
            h: q
        }).setProtocol(s).toString();
    }

    function l(p, q) {
        var r = c('$')('meta_referrer');
        r.content = c('LinkshimHandlerConfig').switched_meta_referrer_policy;
        setTimeout(function() {
            r.content = c('LinkshimHandlerConfig').default_meta_referrer_policy;
            n(p, q);
        }, 100);
    }

    function m(p) {
        c('Bootloader').loadModules(["AsyncSignal", "XLinkshimLogController"], p || c('emptyFunction'), 'AbstractLink.react');
    }

    function n(p, q) {
        m(function(r, s) {
            var t = c('LinkshimHandlerConfig').render_verification_rate || 0,
                u = Math.floor(Math.random() * t + 1) === t,
                v = s.getURIBuilder().setString('u', p).setString('h', q).setBool('render_verification', u).getURI();
            new r(v).send();
        });
    }
    h = babelHelpers.inherits(o, c('React').Component);
    i = h && h.prototype;

    function o() {
        var p, q;
        for (var r = arguments.length, s = Array(r), t = 0; t < r; t++) s[t] = arguments[t];
        return q = (p = i.constructor).call.apply(p, [this].concat(s)), this.$AbstractLink1 = function(u) {
            var v = this.props,
                w = v.href,
                x = v.shimhash,
                y = v.useMetaReferrer,
    ...
    o.prototype.componentDidMount = function() {
        if (this.props.useMetaReferrer) m();
    };
    o.prototype.render = function() {
        var p = this.props,
            ...
            w = p.noopener,
            x = p.rel,
            y = babelHelpers.objectWithoutProperties(p, ['href', 'shimhash', 'onClick', 'useRedirect', 'useMetaReferrer', 'nofollow', 'noopener', 'rel']),
            z = q,
            aa = x;
        if (t) z = k(q, r || '');
        if (v) aa = aa ? aa + ' nofollow' : 'nofollow';
        if (w) aa = aa ? aa + ' noopener' : 'noopener';
        return (c('React').createElement('a', babelHelpers['extends']({}, y, {
            href: z,
            rel: aa,
...
__d('Link.react', ['AbstractLink.react', 'isFacebookURI', 'LinkReactUnsafeHrefConfig', 'LinkshimHandlerConfig', 'React', 'URI'], (function a(b, c, d, e, f, g) {
    'use strict';
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    ...
    function l(n) {
        ...
        var o = new(c('URI'))(n),
            p = o.getProtocol();
        return (p === 'http' || p === 'https') && !c('isFacebookURI')(o);
    }
    ...
    m.prototype.render = function() {
        var n = this.props,
            ...
            q = n.href,
            r = n.target,
            s = babelHelpers.objectWithoutProperties(n, ['allowunsafehref', 's', 'href', 'target']),
            t = '#',
            u = null;
        if (q instanceof c('URI')) {
            t = q.toString();
        } else if (typeof q === 'string' && q !== '' && q !== '#') {
            t = q;
        } else if (typeof q === 'object' && q !== null) {
            t = q.url.toString();
            u = q.shimhash ? q.shimhash.toString() : u;
        } else {
            t = '#';
            u = null;
        }
        if (j) j.logIfInvalidProtocol(t, o);
        if (u == null && l(t)) u = c('LinkshimHandlerConfig').link_react_default_hash;
        var v = u != null,
            w = u != null,
            x = false;
        ...
        var y = c('LinkshimHandlerConfig').use_rel_no_opener && u !== null && r === '_blank';
        return (c('React').createElement(c('AbstractLink.react'), babelHelpers['extends']({}, s, {
            href: t,
            nofollow: v,
            noopener: y,
            shimhash: u,
...
__d('EmojiImageURL', ['invariant', 'EmojiStaticConfig', 'EmojiConfig'], (function a(b, c, d, e, f, g, h) {
    ...
    function j(k, l, m) {
        !(l in c('EmojiStaticConfig').supportedSizes) ? h(0): void 0;
...
__d('EmojiRenderer', ['EmojiRendererData', 'UnicodeUtils'], (function a(b, c, d, e, f, g) {
    ...
    function s(u) {
        ...
        if (c('EmojiRendererData').isText(v.charCodeAt(0)))
            if (u.length < 2) {
                return false;
            } else if (u.length == 2) {
            return c('EmojiRendererData').isNonSpacingCombiningMark(u[1].charCodeAt(0));
        } else {
            var w = 1;
            if (c('EmojiRendererData').isEmojiVariationSelector(u[w].charCodeAt(0))) w++;
            while (w < u.length) {
                if (!c('EmojiRendererData').isNonSpacingCombiningMark(u[w].charCodeAt(0))) return false;
                w++;
            }
            return true;
        }
    ...
    var t = {
        parse: function u(v, w) {
            var x = null,
                ...
                ba = v.length;
            while (aa < ba) {
                var ca = v.codePointAt(aa),
                    da = c('UnicodeUtils').getUTF16Length(v, aa),
                    ea = v.substr(aa, da);
                switch (z) {
                    case p:
                        if (c('EmojiRendererData').isRegionalIndicator(ca)) {
                            z = k;
                        } else z = h;
                        break;
                    case l:
                        if (c('EmojiRendererData').isZWJ(ca)) {
                            z = o;
                        } else if (c('EmojiRendererData').isEmojiModifier(ca)) {
                            z = m;
                        } else if (c('EmojiRendererData').isEmojiVariationSelector(ca)) {
                            z = i;
                        } else z = h;
                        break;
                    case i:
                        if (c('EmojiRendererData').isEmojiModifier(ca)) {
                            z = m;
                        } else z = h;
                        break;
                    case j:
                        if (c('EmojiRendererData').isZWJ(ca)) {
                            ...
                            z = n;
                        } else if (c('EmojiRendererData').isNonSpacingCombiningMark(ca)) {
                            z = q;
                        } else z = h;
                        break;
                    case n:
                    case q:
                        if (c('EmojiRendererData').isNonSpacingCombiningMark(ca)) break;
                    case k:
                    case m:
                        if (c('EmojiRendererData').isZWJ(ca)) {
                            z = o;
                    ...
                    case o:
                        if (c('EmojiRendererData').isRegionalIndicator(ca)) {
                            z = p;
                        } else if (c('EmojiRendererData').isEmojiModifierBase(ca)) {
                            z = l;
                        } else if (c('EmojiRendererData').isEmoji(ca)) {
                            z = j;
                        } else z = h;
                        break;
                    case r:
                        if (c('EmojiRendererData').isNonSpacingCombiningMark(ca)) {
                            z = q;
                        } else if (!(c('EmojiRendererData').isEmojiVariationSelector(ca))) z = h;
                        break;
                    default:
                        z = h;
                        break;
                ...
                if (z === h) {
                    if (c('EmojiRendererData').isRegionalIndicator(ca)) {
                        ...
                        z = l;
                    } else if (c('EmojiRendererData').isText(ca)) {
                        z = r;
                    } else if (c('EmojiRendererData').isEmoji(ca)) z = j;
                    if (z !== h) {
                        if (x !== null && s(x.emoji)) y.push(x);
        ...
        render: function u(v, w, x) {
            ...
            y.forEach(function(ba) {
                var ca = ba.offset;
                if (ca > aa) z.push(v.substr(aa, ca - aa));
                z.push(w(ba.emoji));
                aa = ca + ba.length;
            });
            z.push(v.substr(aa, v.length - aa));
            return z;
        },
        containsEmoji: function u(v) {
            return t.parse(v, 1).length === 1;
        },
        countEmoji: function u(v) {
            return t.parse(v).length;
        }
    };
    f.exports = t;
}), null);
__d("Utf16", [], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = {
        decode: function i(j) {
            switch (j.length) {
                ...
                case 2:
                    return 65536 | (j.charCodeAt(0) - 55296) * 1024 | j.charCodeAt(1) - 56320;
            }
        },
        encode: function i(j) {
            if (j < 65536) {
                return String.fromCharCode(j);
            } else return String.fromCharCode(55296 + (j - 65536 >> 10)) + String.fromCharCode(56320 + j % 1024);
        }
    };
    f.exports = h;
}), null);
__d('createEmojiElement', ['cx', 'EmojiConfig', 'JSXDOM'], (function a(b, c, d, e, f, g, h) {
    if (c.__markCompiled) c.__markCompiled();

    function i(j, k) {
        return (c('JSXDOM').span({
            className: (c('EmojiConfig').hasFBEmoji ? "_5mfr" : '') + (' ' + "_47e3")
        }, [c('JSXDOM').img({
            'aria-hidden': true,
            className: 'img',
            height: 16,
...
__d('DOMEmoji', ['cx', 'EmojiConfig', 'EmojiImageURL', 'EmojiRenderer', 'JSXDOM', 'SupportedEmoji', 'Utf16', 'createEmojiElement', 'flattenArray', 'isElementNode'], (function a(b, c, d, e, f, g, h) {
    if (c.__markCompiled) c.__markCompiled();
    var i = {
        MAX_ITEMS: 40,
        transform: function j(k, l) {
            return c('flattenArray')(k.map(function(m) {
                if (!c('isElementNode')(m)) {
                    return c('EmojiRenderer').render(m, function(n) {
                        var o = n.map(function(p) {
                            return c('Utf16').decode(p).toString(16);
                        }).join('_');
                        if (c('SupportedEmoji').emoji[o]) return c('createEmojiElement')(n.join(''), c('EmojiConfig').hasFBEmoji ? c('EmojiImageURL').getFBEmojiURL(o) : c('EmojiImageURL').getUnicodeURL(o));
                        return c('JSXDOM').span({
                            className: "_4ay8 _3kkw"
                        }, n.join(''));
                    }, this.MAX_ITEMS);
                } else return m;
            }.bind(this)));
...
__d("EmoticonsList", [], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    f.exports = {
        emotes: {
            "O:)": "angel",
        ...
        regexp: /(^|[\s\'\".])(O:\)(?!\))|O:\-\)(?!\))|:3|o\.O|O\.o|:\'\(|:\'\-\(|3:\)(?!\))|3:\-\)(?!\))|:\(|:\-\(|:\[|=\(|\)=|:o|:\-O|:O|:\-o|8\-\)(?!\))|B\-\)(?!\))|=D|:\-D|:D|>:\(|>:\-\(|<3|&lt;3|\^_\^|\^~\^|:\*|:\-\*|\(y\)(?!\))|:like:|\(Y\)(?!\))|:v|:V|<\(\"\)(?!\))|:poop:|:putnam:|:\|\]|\(\^\^\^\)(?!\))|:\)(?!\))|:\-\)(?!\))|:\]|=\)(?!\))|\(:|\(=|\-_\-|B\||8\-\||8\||B\-\||:P|:\-P|:\-p|:p|=P|:\/|:\-\/|:\\|:\-\\|=\/|=\\|>:o|>:O|>:\-O|>:\-o|>_<|>\.<|;\)(?!\))|;\-\)(?!\)))([\s\'\".,!?]|<br>|$)/,
        noncapturingRegexp: /(?:^|[\s\'\".])(O:\)(?!\))|O:\-\)(?!\))|:3|o\.O|O\.o|:\'\(|:\'\-\(|3:\)(?!\))|3:\-\)(?!\))|:\(|:\-\(|:\[|=\(|\)=|:o|:\-O|:O|:\-o|8\-\)(?!\))|B\-\)(?!\))|=D|:\-D|:D|>:\(|>:\-\(|<3|&lt;3|\^_\^|\^~\^|:\*|:\-\*|\(y\)(?!\))|:like:|\(Y\)(?!\))|:v|:V|<\(\"\)(?!\))|:poop:|:putnam:|:\|\]|\(\^\^\^\)(?!\))|:\)(?!\))|:\-\)(?!\))|:\]|=\)(?!\))|\(:|\(=|\-_\-|B\||8\-\||8\||B\-\||:P|:\-P|:\-p|:p|=P|:\/|:\-\/|:\\|:\-\\|=\/|=\\|>:o|>:O|>:\-O|>:\-o|>_<|>\.<|;\)(?!\))|;\-\)(?!\)))(?:[\s\'\".,!?]|<br>|$)/
    };
}), null);
__d('TransformTextToDOMMixin', ['flattenArray', 'isElementNode'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = 3,
        i = {
            transform: function j(k, l) {
                return c('flattenArray')(k.map(function(m) {
                    if (!c('isElementNode')(m)) {
                        var n = m,
                            ...
                            p = this.MAX_ITEMS || h;
                        while (p--) {
                            var q = l ? [n].concat(l) : [n],
                                r = this.match.apply(this, q);
                            if (!r) break;
                            o.push(n.substring(0, r.startIndex));
                            o.push(r.element);
                            n = n.substring(r.endIndex);
                        }
                        n && o.push(n);
                        return o;
                    }
...
__d('DOMEmote', ['fbt', 'cx', 'CSS', 'EmojiConfig', 'EmojiImageURL', 'EmoticonsList', 'JSXDOM', 'SupportedEmoji', 'TransformTextToDOMMixin'], (function a(b, c, d, e, f, g, h, i) {
    if (c.__markCompiled) c.__markCompiled();
    var j = {
        MAX_ITEMS: 40,
        match: function k(l) {
            var m = c('EmoticonsList').regexp.exec(l);
            ...
            return {
                startIndex: n,
                endIndex: n + k.length,
                element: this._element(k, c('EmoticonsList').emotes[k])
            };
        },
        _element: function k(l, m) {
            var n = c('EmoticonsList').emoji[m],
                o = null;
            if (c('EmojiConfig').hasFBEmoji && n && c('SupportedEmoji').emoji[n]) {
                o = c('JSXDOM').img({
                    'aria-hidden': true,
                    className: 'img',
                    height: 16,
                    src: c('EmojiImageURL').getFBEmojiURL(n),
                    width: 16
                });
            } else o = c('JSXDOM').span({
                'aria-hidden': true,
                className: 'emoticon emoticon_' + m
            });
            var p = h._("{emoticonName} emoticon", [h.param('emoticonName', m)]);
            return (c('JSXDOM').span({
                className: "_47e3",
                title: p
            }, [o, c('JSXDOM').span({
    ...
    f.exports = Object.assign(j, c('TransformTextToDOMMixin'));
}), null);
...
__d('emojiAndEmote', ['DOMEmoji', 'DOMEmote', 'transformTextToDOM'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = function i(j) {
        var k = [c('DOMEmoji'), c('DOMEmote')];
        return c('transformTextToDOM')(j, k);
    };
    f.exports = h;
}), null);
__d('Emoji', ['DOMEmoji', 'JSXDOM', 'emojiAndEmote', 'transformTextToDOM'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = {
        htmlEmojiAndEmote: function i(j, k) {
            return c('JSXDOM').span(null, c('emojiAndEmote')(j)).innerHTML;
        },
        htmlEmojiAndEmoteWithoutFBID: function i(j, k) {
            return c('JSXDOM').span(null, c('emojiAndEmote')(j, false)).innerHTML;
        },
        htmlEmoji: function i(j) {
            return c('JSXDOM').span(null, c('transformTextToDOM')(j, c('DOMEmoji'))).innerHTML;
        }
    };
    f.exports = h;
}), null);
__d('Emote', ['DOMEmote', 'JSXDOM', 'transformTextToDOM'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = {
        htmlEmoteWithoutFBID: function i(j, k) {
            return c('JSXDOM').span(null, c('transformTextToDOM')(j, c('DOMEmote'))).innerHTML;
        },
        htmlEmote: function i(j, k) {
            return (c('JSXDOM').span(null, c('transformTextToDOM')(j, [c('DOMEmote')])).innerHTML);
        }
    };
    f.exports = h;
}), null);
__d('TextWithEmoticons.react', ['Emoji', 'Emote', 'React'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    h = babelHelpers.inherits(j, c('React').Component);
    i = h && h.prototype;
    j.prototype.render = function() {
        'use strict';
        if (!this.props.renderEmoticons && !this.props.renderEmoji) return c('React').createElement('span', null, this.props.text);
        var k;
        if (this.props.renderEmoticons && this.props.renderEmoji) {
            k = c('Emoji').htmlEmojiAndEmoteWithoutFBID(this.props.text);
        } else if (this.props.renderEmoticons) {
            k = c('Emote').htmlEmoteWithoutFBID(this.props.text);
        } else k = c('Emoji').htmlEmoji(this.props.text);
        if (k.indexOf('<') === -1) return c('React').createElement('span', null, this.props.text);
...
__d('TooltipMixin', ['React', 'ReactDOM', 'TooltipData', 'DOM'], (function a(b, c, d, e, f, g) {
    ...
    var j = {
        ...
        componentDidUpdate: function k(l, m) {
            if (m.tooltipContainer && !this.state.tooltipContainer) this._cleanupContainer(m.tooltipContainer);
            this._updateTooltip();
        },
        _updateTooltip: function k() {
            ...
            if (i(this.props)) {
                ...
                c('ReactDOM').render(this.props.tooltip, l);
            } else l = this.props.tooltip;
            if (l != null) {
                c('TooltipData').set(c('ReactDOM').findDOMNode(this), l, this.props.position, this.props.alignH);
            } else c('TooltipData').remove(c('ReactDOM').findDOMNode(this));
        },
...
__d('UFIShareLink.react', ['cx', 'fbt', 'CurrentUser', 'React', 'TrackingNodes', 'XUISpinner.react', 'joinClasses'], (function a(b, c, d, e, f, g, h, i) {
    ...
    function l() {
        ...
        return n = (m = k.constructor).call.apply(m, [this].concat(p)), this.$UFIShareLink1 = function(event) {
            if (this.props.href && this.props.href !== '#' && !this.props.onClick) return;
    ...
    l.prototype.render = function() {
        'use strict';
        var m = i._("Send this to friends or post it on your timeline.");
        if (c('CurrentUser').isWorkUser()) m = i._("Send this to coworkers or post it on your timeline.");
        var n = '{ "tn": "' + c('TrackingNodes').encodeTN(c('TrackingNodes').types.SHARE_LINK) + '", "type": 25 }',
            o = null;
        if (this.props.rel !== 'dialog') o = c('React').createElement(c('XUISpinner.react'), {
            className: "UFIShareLinkSpinner _1wfk",
            showOnAsync: true
        });
        return (c('React').createElement('a', babelHelpers['extends']({}, this.props, {
            className: c('joinClasses')(this.props.className, "share_action_link _5f9b"),
            onClick: this.$UFIShareLink1,
            'data-ft': n,
            title: m
        }), i._(["Share", "6f71ca7e66e58b68f0a285b6c5a89ddc"]), o));
    };
    f.exports = l;
}), null);
...
__d('AbstractButton.react', ['cx', 'Link.react', 'React', 'cloneWithProps_DEPRECATED', 'joinClasses'], (function a(b, c, d, e, f, g, h) {
    ...
    function l() {
        ...
        'use strict';
        for (var o = arguments.length, p = Array(o), q = 0; q < o; q++) p[q] = arguments[q];
        return n = (m = j.constructor).call.apply(m, [this].concat(p)), this.handleLinkClick = function(r) {
    ...
    l.prototype.render = function() {
        'use strict';
        var m = "_42ft" + (this.props.disabled ? ' ' + "_42fr" : '') + (this.props.depressed ? ' ' + "_42fs" : ''),
            n, o = this.props.image;
        if (o) {
            n = {};
            if (this.props.label) {
                n.alt = '';
            ...
            o = c('cloneWithProps_DEPRECATED')(o, n);
        }
        ...
        if (p) {
            ...
            p = c('cloneWithProps_DEPRECATED')(p, n);
        }
        var q = Object.assign({}, this.props);
        delete q.image;
        delete q.imageRight;
        delete q.depressed;
        delete q.label;
        var r;
        if (this.props.href) {
            r = c('React').createElement(c('Link.react'), babelHelpers['extends']({}, q, {
            ...
            r = c('React').createElement('button', babelHelpers['extends']({}, q, {
                className: c('joinClasses')(this.props.className, m),
                label: null,
                type: this.props.type
            }), o, this.props.label, p);
        } else r = c('React').createElement('button', babelHelpers['extends']({}, q, {
            className: c('joinClasses')(this.props.className, m),
            label: null,
            type: 'submit',
            value: '1'
...
__d('XUIText.react', ['cx', 'React', 'joinClasses'], (function a(b, c, d, e, f, g, h) {
    ...
    l.prototype.render = function() {
        ...
        var m = this.props,
            ...
            p = m.weight,
            q = m.display,
            r = babelHelpers.objectWithoutProperties(m, ['type', 'size', 'weight', 'display']),
            s = (n === 'serif' ? "_5s6c" : '') + (o === 'small' ? ' ' + "_50f3" : '') + (o === 'medium' ? ' ' + "_50f4" : '') + (o === 'large' ? ' ' + "_50f5" : '') + (o === 'xlarge' ? ' ' + "_50f6" : '') + (p === 'bold' ? ' ' + "_50f7" : '') + (p === 'normal' ? ' ' + "_5kx5" : '');
        if (q === 'block') return (c('React').createElement('div', babelHelpers['extends']({}, r, {
...
__d('ImageCore.react', ['Bootloader', 'createCancelableFunction', 'EncryptedImgUtils', 'React', 'joinClasses'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
...
__d('UnicodeBidi', ['invariant', 'UnicodeBidiDirection', 'UnicodeBidiGlobalDirection'], (function a(b, c, d, e, f, g, h) {
    ...
    function o(s, t) {
        ...
        !c('UnicodeBidiDirection').isStrong(t) ? h(0) : void 0;
        return n(s, t);
    }
...
__d('LitestandClassicPlaceHolders', ['Arbiter'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = {},
        i = {
    ...
    var h = {
        ...
        ensureVisible: function i(j, k, l, m, n) {
            ...
            var o = c('Vector').getScrollPosition().x,
                ...
                q = p + c('Vector').getViewportDimensions().y,
                r = c('Vector').getElementPosition(j).y,
                s = r + c('Vector').getElementDimensions(j).y;
            r -= c('ViewportBounds').getTop();
            r -= l;
            s += l;
            if (r < p) {
                h.scrollTo(new(c('Vector'))(o, r, 'document'), m, false, false, 0, n);
            } else if (s > q)
                if (r - (s - q) < p) {
                    h.scrollTo(new(c('Vector'))(o, r, 'document'), m, false, false, 0, n);
                } else h.scrollTo(new(c('Vector'))(o, s, 'document'), m, false, true, 0, n);
        },
...
__d('ReactRenderer', ['React', 'ReactDOM', 'Run', '$'], (function a(b, c, d, e, f, g) {
    'use strict';
    if (c.__markCompiled) c.__markCompiled();
...
__d('ViewportTrackingHelper', ['DOMDimensions', 'Vector', 'getElementPosition', 'getViewportDimensions'], (function a(b, c, d, e, f, g) {
    ...
    var h = {
        ...
        isVisible: function i(j, k, l) {
            return h.isVisibleInDimension(c('getViewportDimensions')(), j, k, l);
        },
        isVisibleInDimension: function i(j, k, l, m) {
            var n = c('getElementPosition')(k),
                o = c('DOMDimensions').getElementDimensions(k);
            if (!n.x && !n.y && !o.x && !o.y) return false;
            var p = j.height;
            if (m != null) {
                var q = c('Vector').getScrollPosition().y,
                    r = p + m - q;
                if (n.y < r) return true;
            }
            var s = Math.max(n.y, 0),
                t = Math.min(n.y + o.height, p),
                u = Math.min(o.height, l);
            return t - s >= u;
        },
...
__d('FbFeedHighlight', ['cx', 'JSXDOM', 'CSS', 'DOM', 'DOMScroll'], (function a(b, c, d, e, f, g, h) {
    ...
    var m = {
        ...
        scrollTo: function n(o, p) {
            setTimeout(c('DOMScroll').scrollTo.bind(null, o, 750, false, false, p), 0);
        }
    };
    f.exports = m;
}), null);
__d('CommentPrelude', ['BanzaiODS', 'CSS', 'ErrorUtils', 'Parent', 'clickRefAction', 'ex', 'ifRequired'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();

    function h(n, o) {
        if (n === 'ufi.react' || n === 'ufi_mentions_input.react' || n === 'ufi_controller' || n === 'action_link_bling' || n === 'action_link_timeline_bling') return;
        var p = new Error(c('ex')('Deprecated CommentPrelude action %s called from ref %s', o || 'unknown', n || 'unknown'));
        p.type = 'warn';
        c('ErrorUtils').reportError(p);
        c('BanzaiODS').bumpEntityKey('comment_prelude', n);
    }

    function i(n, o, p) {
        h(p, 'click');
        var q = c('Parent').byTag(n, 'form');
        if (!q || !c('CSS').hasClass(q, 'collapsible_comments')) return;
        c('clickRefAction')('ufi', n, null, 'FORCE');
        return j(n, o, p);
    }
    ...
    function j(n, o, p) {
        ...
        k(q, p);
        if (o !== false) {
            var r = q.add_comment_text_text || q.add_comment_text,
                s = r.length;
            if (s)
                if (!c('Parent').byClass(r[s - 1], 'UFIReplyList')) {
                    r = r[s - 1];
                } else if (!c('Parent').byClass(r[0], 'UFIReplyList')) {
                r = r[0];
            } else r = null;
            if (r) {
                r.focus();
                c('ifRequired')('FbFeedCommentUFIScroller', function(t) {
                    return t.reveal(r);
                });
            }
        }
    ...
    function k(n, o) {
        h(o, 'uncollapse');
        if (!n || !c('CSS').hasClass(n, 'collapsible_comments')) return;
        var p = c('CSS').removeClass.bind(null, n, 'collapsed_comments');
        c('ifRequired')('ScrollAwareDOM', function(q) {
            return q.monitor(n, p);
        }, function() {
            return p();
        });
    }
    ...
    function l(n) {
        var o = n.getAttribute('data-comment-prelude-ref');
        h(o, 'blingbox');
        var p = c('Parent').byTag(n, 'form');
        if (!p || !c('CSS').hasClass(p, 'collapsible_comments')) return;
        c('CSS').toggleClass(p, 'collapsed_comments');
    }
    var m = {
        click: i,
        expand: j,
...
__d('Scrollable', ['Event', 'Parent', 'Scroll', 'UserAgent_DEPRECATED'], (function a(b, c, d, e, f, g) {
    ...
    var h = function k(event) {
            ...
            if (n > o) {
                ...
                if (m > 0 && p === 0 || m < 0 && p >= n - o - 1) {
                    event.prevent();
                } else if (c('UserAgent_DEPRECATED').ie() < 9)
                    if (l.currentStyle) {
    ...
    if (c('UserAgent_DEPRECATED').firefox()) {
        ...
        i.addEventListener(j, h, false);
    } else c('Event').listen(i, 'mousewheel', h);
}), null);
__d('TabIsolation', ['Event', 'Focus', 'Keys', 'TabbableElements', 'containsNode'], (function a(b, c, d, e, f, g) {
    ...
    j.prototype.enable = function() {
        ...
        this.$TabIsolation1 = c('Event').listen(window, 'keydown', function(k) {
            if (h[0] === this.$TabIsolation2) this.$TabIsolation4(k);
    ...
    function k(l, m, n, o) {
        ...
        if (q === '[object Array]') {
            ...
            for (var u = 0; u < t.length; u++)
                if (!k(l[t[u]], m[t[u]], n, o)) return false;
        }
        n.pop();
        o.pop();
        return true;
...
__d('AbstractActionList.react', ['React', 'ReactFragment'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    var j = c('React').createElement('span', {
        role: 'presentation',
        'aria-hidden': 'true'
    }, ' \u00b7 ');
    h = babelHelpers.inherits(k, c('React').Component);
    ...
    k.prototype.render = function() {
        'use strict';
        var l = true,
            m = c('React').Children.map(this.props.children, function(n) {
                if (!n) return n;
                if (l) {
                    l = false;
                    return n;
        ...
        return c('React').createElement('div', this.props, m);
    };
...
__d('Grid.react', ['cx', 'React', 'joinClasses'], (function a(b, c, d, e, f, g, h) {
    var i, j, k, l;
    if (c.__markCompiled) c.__markCompiled();
    var m = c('React').PropTypes;
    i = babelHelpers.inherits(n, c('React').Component);
    j = i && i.prototype;
    n.prototype.render = function() {
        'use strict';
        var p = this.props,
        ...
        c('React').Children.forEach(s, function(aa, ba) {
            ...
            var da = z === t ? "_51mw" : '';
            if (!ca) {
                aa = c('React').createElement(o, {
                    alignh: q,
                    alignv: r,
                    className: c('joinClasses')(v, da),
                    key: aa.key || ba
                }, aa);
            } else aa = c('React').cloneElement(aa, {
                key: aa.key || ba,
                alignh: aa.props.alignh || q,
                alignv: aa.props.alignv || r,
                className: c('joinClasses')(aa.props.className, v, da)
            });
            y.push(aa);
            if (z % t === 0 || ba + 1 === w) {
                if (u && z < t) {
                    for (var ea = z; ea < t; ea++) y.push(c('React').createElement(o, {
                        key: ba + ea
                    }));
                    z = t;
                }
                x.push(c('React').createElement('tr', {
                    className: "_51mx",
                    key: ba
                }, y));
                y = [];
        ...
        return (c('React').createElement('table', babelHelpers['extends']({}, this.props, {
            className: c('joinClasses')(this.props.className, "uiGrid" + (' ' + "_51mz") + (u ? ' ' + "_5f0n" : '')),
            cellSpacing: '0',
            cellPadding: '0'
    ...
    n.propTypes = {
        cols: m.number.isRequired,
        fixed: m.bool,
        alignv: m.oneOf(['top', 'middle', 'bottom']),
        alignh: m.oneOf(['left', 'center', 'right']),
        spacing: m.string
    };
    ...
    o.prototype.render = function() {
        'use strict';
        var p = c('joinClasses')(this.props.className, "_51m-" + (this.props.alignv === 'top' ? ' ' + "vTop" : '') + (this.props.alignv === 'middle' ? ' ' + "vMid" : '') + (this.props.alignv === 'bottom' ? ' ' + "vBot" : '') + (this.props.alignh === 'left' ? ' ' + "hLeft" : '') + (this.props.alignh === 'center' ? ' ' + "hCent" : '') + (this.props.alignh === 'right' ? ' ' + "hRght" : ''));
        return (c('React').createElement('td', babelHelpers['extends']({}, this.props, {
            className: p
        })));
    };
...
__d('LeftRight.react', ['cx', 'invariant', 'React', 'keyMirror', 'joinClasses'], (function a(b, c, d, e, f, g, h, i) {
    ...
    function m(p) {
        !(p && (p.length === 1 || p.length === 2)) ? i(0): void 0;
    }
...
__d('ImageBlock.react', ['cx', 'invariant', 'LeftRight.react', 'React', 'joinClasses'], (function a(b, c, d, e, f, g, h, i) {
    ...
    function l(o) {
        !(o.children && (o.children.length === 2 || o.children.length === 3)) ? i(0): void 0;
    }
    ...
    n.prototype.render = function() {
        'use strict';
        l(this.props);
        var o = this.props.children[0],
            p = this.props.children[1],
            q = this.props.children[2],
            r = this.props.spacing || 'small',
            s = {
                className: c('joinClasses')(o.props.className, m(r), this.props.imageClassName)
            };
        if (o.type === 'img') {
            if (o.props.alt === undefined) s.alt = '';
        } else if ((o.type === 'a' || o.type === 'link') && o.props.tabIndex === undefined && o.props.title === undefined && o.props['aria-label'] === undefined) {
            s.tabIndex = '-1';
            s['aria-hidden'] = 'true';
        }
        o = c('React').cloneElement(o, s);
        var t = c('joinClasses')(this.props.contentClassName, "_42ef" + (r === 'small' ? ' ' + "_8u" : '')),
            u;
        if (!q) {
            u = c('React').createElement('div', {
                className: t
            }, p);
        } else u = c('React').createElement(c('LeftRight.react'), {
            className: t,
            direction: c('LeftRight.react').DIRECTION.right
        }, p, q);
        return (c('React').createElement(c('LeftRight.react'), babelHelpers['extends']({}, this.props, {
...
__d('Layout.react', ['cx', 'FlexLayoutConfig', 'React', 'joinClasses'], (function a(b, c, d, e, f, g, h) {
    var i, j;
    if (c.__markCompiled) c.__markCompiled();
    ...
    k.prototype.render = function() {
        var l, m = this,
            n;
        'use strict';
        if (c('FlexLayoutConfig').a11yFlexLayout) {
            var l = function() {
                var p = false,
                    q = false;
                c('React').Children.forEach(m.props.children, function(r) {
                    if (!r) return;
                    if (r.type === k.FillColumn) {
                        q = true;
                    } else if (q) p = true;
                });
                return {
                    v: c('React').createElement('div', babelHelpers['extends']({}, m.props, {
                        className: c('joinClasses')(m.props.className, p ? "_5aj7" : "clearfix _ikh")
                    }), m.props.children)
                };
            }();
            ...
            var o, n = function() {
                var p = [],
                    q = [],
                    r = null;
                c('React').Children.forEach(m.props.children, function(s, t) {
                    if (!s) return;
                    var u = r !== null,
                        v = c('React').cloneElement(s, {
                            className: c('joinClasses')(s.props.className, u ? "_3-z3" : ''),
                            key: t
                        });
                    if (r === null) {
                        if (s.type === k.FillColumn) {
                            r = v;
                        } else p.push(v);
                    } else q.push(v);
                });
                ...
                return {
                    v: c('React').createElement('div', babelHelpers['extends']({}, m.props, {
                        className: c('joinClasses')(m.props.className, 'clearfix')
                    }), o)
                };
            }();
    ...
    k.Column = function() {
        ...
        n.prototype.render = function() {
            ...
            } else return (c('React').createElement('div', babelHelpers['extends']({}, this.props, {
                className: c('joinClasses')(this.props.className, "_5k5")
            })));
        };
    ...
    k.FillColumn = function() {
        ...
        n.prototype.render = function() {
            ...
            if (c('FlexLayoutConfig').a11yFlexLayout) {
                ...
                className: c('joinClasses')(this.props.className, "_2cpb")
            })));
        };
...
__d('PhotosMimeType', [], (function a(b, c, d, e, f, g) {
    ...
    var h = {
        ...
        isJpeg: function j(k) {
            var l = i(k);
            return (h.isImage(k) && (l[1] === 'jpeg' || l[1] === 'pjpeg'));
        }
    };
...
__d('DataTransfer', ['PhotosMimeType', 'createArrayFromMixed', 'emptyFunction'], (function a(b, c, d, e, f, g) {
    ...
    function k(m) {
        if (m.kind == 'file') return m.getAsFile();
    }
    ...
    l.prototype.isRichText = function() {
        'use strict';
    ...
    l.prototype.getText = function() {
        ...
        if (this.data.getData)
            if (!this.types.length) {
                m = this.data.getData('Text');
            } else if (this.types.indexOf('text/plain') != -1) m = this.data.getData('text/plain');
    ...
    l.prototype.isLink = function() {
        'use strict';
        return this.types.some(function(m) {
            return m.indexOf('Url') != -1 || m.indexOf('text/uri-list') != -1 || m.indexOf('text/x-moz-url');
        });
    };
    l.prototype.getLink = function() {
        'use strict';
        if (this.data.getData) {
    ...
    l.prototype.isImage = function() {
        ...
        for (var o = 0; o < n.length; o++) {
            var p = n[o].type;
            if (!c('PhotosMimeType').isImage(p)) return false;
        }
        return true;
    };
    ...
    l.prototype.getFiles = function() {
        'use strict';
        if (this.data.items) {
            return Array.prototype.slice.call(this.data.items).map(k).filter(c('emptyFunction').thatReturnsArgument);
        } else if (this.data.files) {
            return Array.prototype.slice.call(this.data.files);
        } else return [];
    };
    l.prototype.hasFiles = function() {
        'use strict';
...
__d('FluxStoreGroup', ['invariant'], (function a(b, c, d, e, f, g, h) {
    ...
    function i(k, l) {
        ...
        this.$FluxStoreGroup1 = this.__dispatcher.register(function(n) {
    ...
    i.prototype.release = function() {
        this.__dispatcher.unregister(this.$FluxStoreGroup1);
    };
    i.prototype.getDispatchToken = function() {
...
__d('FluxContainerSubscriptions', ['FluxStoreGroup'], (function a(b, c, d, e, f, g) {
    ...
    function h() {
        this.$FluxContainerSubscriptions1 = [];
    }
    h.prototype.setStores = function(i) {
        var j, k = this;
        this.$FluxContainerSubscriptions4();
        this.$FluxContainerSubscriptions5();
        var l = false,
            m = [];
        (function() {
            var o = function p() {
            ...
            k.$FluxContainerSubscriptions3 = i.map(function(p) {
                return p.addListener(o);
            });
        })();
        var n = function() {
            if (l) {
                this.$FluxContainerSubscriptions1.forEach(function(o) {
                    return o();
                });
                l = false;
            }
        }.bind(this);
        this.$FluxContainerSubscriptions2 = new(c('FluxStoreGroup'))(i, n);
    };
    h.prototype.addListener = function(i) {
        this.$FluxContainerSubscriptions1.push(i);
    };
    h.prototype.reset = function() {
        this.$FluxContainerSubscriptions4();
        this.$FluxContainerSubscriptions5();
        this.$FluxContainerSubscriptions6();
    };
    h.prototype.$FluxContainerSubscriptions4 = function() {
        if (this.$FluxContainerSubscriptions3) {
            this.$FluxContainerSubscriptions3.forEach(function(i) {
                return i.remove();
            });
            this.$FluxContainerSubscriptions3 = null;
        }
    };
    h.prototype.$FluxContainerSubscriptions5 = function() {
        if (this.$FluxContainerSubscriptions2) {
            this.$FluxContainerSubscriptions2.release();
            this.$FluxContainerSubscriptions2 = null;
        }
    };
    h.prototype.$FluxContainerSubscriptions6 = function() {
        this.$FluxContainerSubscriptions1 = [];
    };
    f.exports = h;
}), null);
__d('FluxContainer', ['invariant', 'FluxContainerSubscriptions', 'React', 'shallowEqual'], (function a(b, c, d, e, f, g, h) {
    'use strict';
    if (c.__markCompiled) c.__markCompiled();
    var i = c('React').Component,
        j = c('React').PureComponent,
        k = {
            pure: true,
            withProps: false,
            withContext: false
    ...
    function l(p, q) {
        var r, s;
        n(p);
        var t = babelHelpers['extends']({}, k, q || {}),
        ...
        r = babelHelpers.inherits(w, p);
        s = r && r.prototype;

        function w(z, aa) {
            'use strict';
            s.constructor.call(this, z, aa);
            this.$ContainerClass1 = new(c('FluxContainerSubscriptions'))();
            this.$ContainerClass1.setStores(v(z));
            this.$ContainerClass1.addListener(function() {
                this.setState(function(ca, da) {
                    return u(ca, da, aa);
                });
            }.bind(this));
            var ba = u(undefined, z, aa);
            this.state = babelHelpers['extends']({}, this.state || {}, ba);
        }
        w.prototype.componentWillReceiveProps = function(z, aa) {
            'use strict';
            if (s.componentWillReceiveProps) s.componentWillReceiveProps.call(this, z, aa);
            if (t.withProps || t.withContext) {
                this.$ContainerClass1.setStores(v(z, aa));
        ...
        w.prototype.componentWillUnmount = function() {
            'use strict';
            if (s.componentWillUnmount) s.componentWillUnmount.call(this);
            this.$ContainerClass1.reset();
        };
        var x = t.pure && !(p.prototype instanceof j) ? m(w) : w,
    ...
    function m(p) {
        var q, r;
        q = babelHelpers.inherits(s, p);
        r = q && q.prototype;
        s.prototype.shouldComponentUpdate = function(t, u) {
            'use strict';
            return (!c('shallowEqual')(this.props, t) || !c('shallowEqual')(this.state, u));
        };
    ...
    function n(p) {
        !p.getStores ? h(0) : void 0;
        !p.calculateState ? h(0) : void 0;
    }

    function o(p, q, r, s) {
        var t, u;
        t = babelHelpers.inherits(v, i);
        u = t && t.prototype;
        v.getStores = function(x, y) {
            'use strict';
            return q(x, y);
        };
        v.calculateState = function(x, y, z) {
            'use strict';
            return r(x, y, z);
        };
...
__d('xuiglyph', ['ix'], (function a(b, c, d, e, f, g, h) {
    'use strict';
    if (c.__markCompiled) c.__markCompiled();
    ...
    function i(j) {
        ...
        return h.call(null, k.name + ':' + k.shade + ':' + k.size);
    }
    f.exports = i;
}), null);
__d('LoadOnRender.react', ['React', 'createCancelableFunction'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    h = babelHelpers.inherits(j, c('React').Component);
    i = h && h.prototype;
    ...
    function j(k) {
        ...
        this.state = {
            Component: null,
            cancelableOnComponentLoad: c('createCancelableFunction')(this.$LoadOnRender1)
        };
    }
    ...
    j.prototype.render = function() {
        ...
        if (!k || this.props.forcePlaceholder) return this.props.placeholder;
...
__d('BootloadOnRender.react', ['JSResource', 'LoadOnRender.react', 'React'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    h = babelHelpers.inherits(j, c('React').Component);
    i = h && h.prototype;
    ...
    function j() {
        ...
        return l = (k = i.constructor).call.apply(k, [this].concat(n)), this.$BootloadOnRender1 = function(p) {
    ...
    j.prototype.render = function() {
        ...
        return (c('React').createElement(c('LoadOnRender.react'), {
            ...
            loader: this.$BootloadOnRender1,
            component: this.props.component
        }));
    };
    f.exports = j;
}), null);
__d('LazyComponent.react', ['React'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    h = babelHelpers.inherits(j, c('React').Component);
    i = h && h.prototype;
    j.prototype.render = function() {
        'use strict';
        var k = this.props,
            l = k.LazyLoadedComponent,
            m = babelHelpers.objectWithoutProperties(k, ['LazyLoadedComponent']);
        return c('React').createElement(l, m);
    };
    ...
    j.defaultProps = {
        LazyLoadedComponent: function k() {
            return null;
        }
    };
    f.exports = j;
...
__d('xhrSimpleDataSerializer', [], (function a(b, c, d, e, f, g) {
    ...
    function h(i) {
        var j = [],
            k;
        for (k in i) j.push(encodeURIComponent(k) + '=' + encodeURIComponent(i[k]));
        return j.join('&');
    }
    f.exports = h;
}), null);
__d('XHRRequest', ['invariant', 'ErrorUtils', 'TimeSlice', 'URI', 'XHRHttpError', 'ZeroRewrites', 'getAsyncHeaders', 'xhrSimpleDataSerializer'], (function a(b, c, d, e, f, g, h) {
    if (c.__markCompiled) c.__markCompiled();
    var i = {
            errorCode: null,
            errorMsg: null,
    ...
    k.prototype.setURI = function(m) {
        'use strict';
        this.$XHRRequest1 = c('ZeroRewrites').rewriteURI(new(c('URI'))(m));
        return this;
    };
    ...
    k.prototype.setResponseType = function(m) {
        'use strict';
        this.$XHRRequest2 = m;
        return this;
    };
    k.prototype.setMethod = function(m) {
        'use strict';
        this.$XHRRequest3 = m;
        return this;
    };
    ...
    k.prototype.setData = function(m) {
        'use strict';
        this.$XHRRequest4 = m;
        return this;
    };
    ...
    k.prototype.setRawData = function(m) {
        'use strict';
        this.$XHRRequest5 = m;
        return this;
    };
    k.prototype.setRequestHeader = function(m, n) {
        'use strict';
        if (!this.$XHRRequest6) this.$XHRRequest6 = {};
        this.$XHRRequest6[m] = n;
        return this;
    };
    k.prototype.setTimeout = function(m) {
        'use strict';
        this.$XHRRequest7 = m;
        return this;
    };
    ...
    k.prototype.setResponseHandler = function(m) {
        'use strict';
        this.$XHRRequest8 = m;
        return this;
    };
    k.prototype.setErrorHandler = function(m) {
        'use strict';
        this.$XHRRequest9 = m;
        return this;
    };
    ...
    k.prototype.setAbortHandler = function(m) {
        'use strict';
        this.$XHRRequest10 = m;
        return this;
    };
    ...
    k.prototype.setTimeoutHandler = function(m) {
        'use strict';
        this.$XHRRequest11 = m;
        return this;
    };
    k.prototype.setUploadProgressHandler = function(m) {
        'use strict';
        this.$XHRRequest12 = m;
        return this;
    };
    k.prototype.setDownloadProgressHandler = function(m) {
        'use strict';
        this.$XHRRequest13 = m;
        return this;
    };
    k.prototype.setTransportBuilder = function(m) {
        'use strict';
        this.$XHRRequest14 = m;
        return this;
    };
    k.prototype.setDataSerializer = function(m) {
        'use strict';
        this.$XHRRequest15 = m;
        return this;
    };
    k.prototype.send = function() {
        'use strict';
        var m = this.$XHRRequest7,
            n = this.$XHRRequest14(),
            o = this.getURI();
        this.$XHRRequest16 = n;
        var p;
        !(this.$XHRRequest3 === 'POST' || !this.$XHRRequest5) ? h(0): void 0;
        if (this.$XHRRequest3 === 'GET' || this.$XHRRequest5) {
            o.addQueryData(this.$XHRRequest4);
            p = this.$XHRRequest5;
        } else p = this.$XHRRequest15(this.$XHRRequest4);
        n.onreadystatechange = c('TimeSlice').guard(this.$XHRRequest17, 'XHRRequest onreadystatechange');
        if (n.upload && this.$XHRRequest12) n.upload.onprogress = this.$XHRRequest18.bind(this);
        if (this.$XHRRequest13) n.onprogress = this.$XHRRequest19.bind(this);
        if (m) this.$XHRRequest20 = setTimeout(this.$XHRRequest21.bind(this), m);
        n.open(this.$XHRRequest3, o.toString(), true);
        if (this.$XHRRequest6)
            for (var q in this.$XHRRequest6) n.setRequestHeader(q, this.$XHRRequest6[q]);
        var r = c('getAsyncHeaders')(o);
        Object.keys(r).forEach(function(s) {
            n.setRequestHeader(s, r[s]);
        });
        if (this.$XHRRequest2 === 'arraybuffer')
            if ('responseType' in n) {
                n.responseType = 'arraybuffer';
            } else if ('overrideMimeType' in n) {
            n.overrideMimeType('text/plain; charset=x-user-defined');
        } else if ('setRequestHeader' in n) n.setRequestHeader('Accept-Charset', 'x-user-defined');
        if (this.$XHRRequest2 === 'blob') n.responseType = this.$XHRRequest2;
        n.send(p);
    };
    ...
    k.prototype.$XHRRequest24 = function(m) {
        'use strict';
        if (this.$XHRRequest2)
            if ('response' in m) {
                return m.response;
            } else if (this.$XHRRequest2 === 'arraybuffer')
            if (window.VBArray) return window.VBArray(m.responseBody).toArray();
        return m.responseText;
    };
    k.prototype.$XHRRequest18 = function(m) {
        'use strict';
        j.loadedBytes = m.loaded;
        j.totalBytes = m.total;
        if (this.$XHRRequest12) c('ErrorUtils').applyWithGuard(this.$XHRRequest12, null, [j], null, 'XHRRequest:_uploadProgressHandler');
    };
    k.prototype.$XHRRequest19 = function(m) {
        'use strict';
        var n = {
            loadedBytes: m.loaded,
            totalBytes: m.total
        };
        if (this.$XHRRequest13) c('ErrorUtils').applyWithGuard(this.$XHRRequest13, null, [n], null, 'XHRRequest:_downloadProgressHandler');
    };
            ...
            if (o >= 2) {
                ...
                if (r !== null) {
                    if (p) {
                        ...
                        if (this.$XHRRequest9) c('ErrorUtils').applyWithGuard(this.$XHRRequest9, null, [i], null, 'XHRRequest:_errorHandler');
                    }
                } else if (s) {
                    var t = null;
                    if (s.includeHeaders) t = n.getAllResponseHeaders();
                    if (p || s.parseStreaming && o === 3) c('ErrorUtils').applyWithGuard(s, null, [this.$XHRRequest24(n), t, p], null, 'XHRRequest:handler');
                }
