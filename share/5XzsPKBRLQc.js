...
__d('BucketedTypeaheadView', ['fbt', 'DOM', 'TypeaheadView'], (function a(b, c, d, e, f, g, h) {
    ...
    k.prototype.buildBuckets = function(l, m) {
        ...
        for (r in this.typeObjects)
            if (!o.hasOwnProperty(r) && this.typeObjects[r].show_always) {
                o[r] = n.length;
                n.push([this.buildBucketHeader(r)]);
        ...
        if (this.typeObjectsOrder) {
            for (var t = 0; t < this.typeObjectsOrder.length; ++t) {
                ...
                if (o.hasOwnProperty(u)) s = s.concat(n[o[u]]);
            }
        } else
...
__d('TypeaheadShowLoadingIndicator', ['CSS'], (function a(b, c, d, e, f, g) {
    ...
    h.prototype.enable = function() {
        'use strict';
        this._subscription = this._typeahead.subscribe('loading', function(i, j) {
            c('CSS').conditionClass(this._typeahead.getElement(), 'typeaheadLoading', j.loading);
            c('CSS').conditionClass(this._typeahead.getView().getElement(), 'typeaheadViewLoading', j.loading);
        }.bind(this));
    };
...
__d('TypeaheadSubmitOnSelect', ['FormSubmit'], (function a(b, c, d, e, f, g) {
    ...
    h.prototype.enable = function() {
        ...
        this._subscription = this._typeahead.subscribe('select', function() {
            ...
            if (i) i.getAttribute('rel') == 'async' ? c('FormSubmit').send(i) : i.submit();
        }.bind(this));
    };
    h.prototype.disable = function() {
        'use strict';
