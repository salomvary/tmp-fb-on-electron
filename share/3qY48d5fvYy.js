if (self.CavalryLogger) {
    CavalryLogger.start_js(["jmaM9"]);
}

__d('PlacesDataSource', ['DataSource'], (function a(b, c, d, e, f, g) {
    var h, i;
    ...
    j.prototype.shouldFetchMoreResults = function(k) {
        ...
        if (this.queryData.new_js_ranking) {
            return true;
        } else return i.shouldFetchMoreResults.call(this, k);
    };
    j.prototype.mergeUids = function(k, l, m, n) {
        'use strict';
        if (this.queryData.new_js_ranking) {
            this._checkExtendedMatch(n, k);
            return this.deduplicateByKey(m.concat(l, k));
        } else return i.mergeUids.call(this, k, l, m, n);
    };
    j.prototype.resetBootstrapEndpoint = function(k) {
        'use strict';
        this.setBootstrapEndpoint(this._origBootstrapEndpoint, k);
        return this;
    };
    j.prototype.setBootstrapEndpoint = function(k, l) {
        'use strict';
        if (this.bootstrapEndpoint !== k) {
            this.bootstrapEndpoint = k;
            if (this._bootstrapped || this._bootstrapping) l = true;
        }
        if (l) this.dirty().bootstrap();
        return this;
    };
    j.prototype.getQueryEndpoint = function() {
        'use strict';
        return this.queryEndpoint;
    };
    j.prototype.getBootstrapData = function() {
        'use strict';
...
__d('SearchFiltersCustomSource', ['csx', 'cx', 'CSS', 'DOM', 'DOMQuery', 'EventListener', 'Form', 'tidyEvent'], (function a(b, c, d, e, f, g, h, i) {
    ...
    function j(k, l, m) {
        ...
        this.placeholder = l;
        this.form = m;
        this.inputs = c('DOMQuery').scry(this.sourceElem, 'input[type="text"]');
    ...
    j.prototype.$SearchFiltersCustomSource1 = function() {
        if (this.inputs.length === 1) this.inputs[0].focus();
    };
...
__d('SearchFiltersFreeFormSelection', ['cx', 'fbt', 'DOM', 'joinClasses'], (function a(b, c, d, e, f, g, h, i) {
    ...
    j.prototype.enable = function() {
        ...
        this.subscription = p.subscribe('beforeRender', function(q, r) {
            var s = String(i._("Use any {entityType} matching \"{value}\"", [i.param('entityType', n), i.param('value', r.value)])),
...
__d('SearchLHCFilters.react', ['DOMContainer.react', 'React', 'ReactDOM', 'ScrollColumn.react', 'onEnclosingPageletDestroy'], (function a(b, c, d, e, f, g) {
    ...
    k.prototype.componentDidMount = function() {
        'use strict';
        c('onEnclosingPageletDestroy')(c('ReactDOM').findDOMNode(this), function() {
