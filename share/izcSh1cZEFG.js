...
__d("ComposerEntryPointRef", [], (function a(b, c, d, e, f, g) {
    ...
    f.exports = {
        ...
        PAGE_CONTNET_TAB_JOB_POSTS: "page_contet_tab_job_posts",
        ...
        RED_ENVELOPE_POST: "red_envelope_post",
        ...
        PRODUCT_TAG_UPSELL: "product_tag_upsell",
        PUBLISH_FRAME_DIALOG: "publish_frame_dialog",
        AYMT: "aymt",
        SW_BG_SYNC: "sw_bg_sync",
...
__d("ReactComposerLoggingName", [], (function a(b, c, d, e, f, g) {
    ...
    f.exports = {
        ...
        RECOMMENDATIONS_DASHBOARD: "recommendations_dashboard",
        RED_ENVELOPE_TAB_SELECTOR: "red_envelope_tab_selector",
...
__d("TranslationRating", [], (function a(b, c, d, e, f, g) {
    c.__markCompiled && c.__markCompiled();
    f.exports = {
        UNDEFINED: 0,
        VERY_BAD: 1,
...
__d("TranslationTrigger", [], (function a(b, c, d, e, f, g) {
    c.__markCompiled && c.__markCompiled();
    f.exports = {
...
__d('SystemEvents', ['ArbiterMixin', 'ErrorUtils', 'SystemEventsInitialData', 'UserAgent_DEPRECATED', 'TimeSlice', 'mixin', 'setIntervalAcrossTransitions'], (function a(b, c, d, e, f, g) {
    ...
    function k() {
        ...
        this.$SystemEvents1 = c('SystemEventsInitialData').ORIGINAL_USER_ID;
        this.$SystemEvents2 = this.$SystemEvents1;
        this.$SystemEvents3 = navigator.onLine;
        this.$SystemEvents4 = Date.now();
        this.$SystemEvents5();
    }
    k.prototype.isPageOwner = function(l) {
        return (l || this.$SystemEvents6()) == this.$SystemEvents1;
    };
    k.prototype.isOnline = function() {
        return !!(c('UserAgent_DEPRECATED').chrome() || this.$SystemEvents3);
    };
    k.prototype.checkTimeTravel = function() {
        var l = Date.now(),
            m = l - this.$SystemEvents4;
        this.$SystemEvents4 = l;
        if (m < 0 || m > 10000) this.inform(this.TIME_TRAVEL, m);
    };
    k.prototype.$SystemEvents5 = function() {
        this.$SystemEvents7();
        this.$SystemEvents8();
        this.$SystemEvents9();
        this.$SystemEvents10();
    };
    k.prototype.$SystemEvents7 = function() {
        var l = c('TimeSlice').guard(function() {
                if (!this.$SystemEvents3) {
                    this.$SystemEvents3 = true;
                    this.inform(this.ONLINE, this.$SystemEvents3);
                }
            }.bind(this), 'SystemEvents onOnline'),
            m = c('TimeSlice').guard(function() {
                if (this.$SystemEvents3) {
                    this.$SystemEvents3 = false;
                    this.inform(this.ONLINE, this.$SystemEvents3);
                }
        ...
        if (c('UserAgent_DEPRECATED').ie()) {
            ...
            } else if (c('UserAgent_DEPRECATED').ie() >= 8) {
                window.attachEvent('onload', function() {
                    document.body.ononline = l;
                    document.body.onoffline = m;
                });
            } else c('setIntervalAcrossTransitions')(function() {
    ...
    k.prototype.$SystemEvents8 = function() {
        c('setIntervalAcrossTransitions')(function() {
            var l = this.$SystemEvents6();
            if (this.$SystemEvents2 != l) {
                this.$SystemEvents2 = l;
                this.inform(this.USER, l);
            }
        }.bind(this), j);
    };
    k.prototype.$SystemEvents9 = function() {
        c('setIntervalAcrossTransitions')(this.checkTimeTravel.bind(this), j);
    };
    k.prototype.$SystemEvents10 = function() {
        c('setIntervalAcrossTransitions')(function() {
            if (window.onerror != c('ErrorUtils').onerror) window.onerror = c('ErrorUtils').onerror;
        }, j);
    };
    k.prototype.$SystemEvents6 = function() {
...
__d('RTISubscriptionManager', ['invariant', 'ChannelConstants', 'CurrentLocale', 'SystemEvents', 'setTimeoutAcrossTransitions', 'Arbiter', 'ErrorUtils', 'Run', 'RTISubscriptionManagerConfig', 'UserActivity'], (function a(b, c, d, e, f, g, h) {
    ...
    function l() {
        this.$RTISubscriptionManager1 = {};
        this.$RTISubscriptionManager2 = null;
        this.$RTISubscriptionManager3;
        this.$RTISubscriptionManager4 = false;
        this.$RTISubscriptionManager5 = false;
        this.$RTISubscriptionManager6 = false;
        this.$RTISubscriptionManager7 = true;
        this.$RTISubscriptionManager8 = document.readyState === 'complete';
        c('Run').onAfterLoad(function() {
            this.$RTISubscriptionManager8 = true;
            this.flush();
        }.bind(this));
        this.$RTISubscriptionManager9 = null;
        c('Arbiter').subscribe(c('ChannelConstants').ON_ENTER_STATE, function(o, p) {
            if (!this.$RTISubscriptionManager9) return;
            var q = /pull/.test(p.state);
            if (!this.$RTISubscriptionManager2 && q) {
                this.$RTISubscriptionManager3 = true;
                if (!this.$RTISubscriptionManager4) {
                    this.$RTISubscriptionManager4 = true;
                    c('setTimeoutAcrossTransitions')(function() {
                        this.$RTISubscriptionManager2 = this.$RTISubscriptionManager3;
                        this.$RTISubscriptionManager4 = false;
                        if (this.$RTISubscriptionManager2) this.flush();
                    }.bind(this), l.PULL_HINT_DELAY_MILLIS);
                }
            } else if (!q) {
                this.$RTISubscriptionManager3 = false;
                this.$RTISubscriptionManager2 = false;
            } else if (q) {
                this.$RTISubscriptionManager2 = true;
                this.flush();
            }
        }.bind(this));
        ...
        c('Arbiter').subscribe(c('ChannelConstants').RTI_SESSION, function(o, p) {
            if (!this.$RTISubscriptionManager9 && p) this.deleteSubscriptions(function(q) {
                return q.getState() === i.UNSUBSCRIBE;
            });
            this.$RTISubscriptionManager9 = p;
            if (this.$RTISubscriptionManager9) {
                this.$RTISubscriptionManager2 = true;
                this.flush();
            }
        }.bind(this));
        ...
        c('Arbiter').subscribe(c('ChannelConstants').SKYWALKER, function(o, p) {
            ...
            if (p.obj.payloads === undefined) {
                r.obj = [p.obj.payload];
            } else r.obj = p.obj.payloads;
            c('Arbiter').inform(c('ChannelConstants').getSkywalkerArbiterType(q), r);
        });
    }
    l.prototype.subscribe = function(o, p, q, r, s) {
        !o ? h(0) : void 0;
        !p ? h(0) : void 0;
        if (Object.keys(this.$RTISubscriptionManager1).length < this.getMaxSubscriptions()) {
            if (this.isSubscribed(o)) {
                var t = this.$RTISubscriptionManager1[o];
                if (t && t.getArbiterToken()) {
                    c('Arbiter').unsubscribe(t.getArbiterToken());
                    t.setArbiterToken(null);
                }
            }
            q = q || {};
            q.locale = c('CurrentLocale').get();
            if (c('RTISubscriptionManagerConfig').autobot && !q.autobotOverrideTier) {
                q.autobotOverrideTier = c('RTISubscriptionManagerConfig').autobot.tier;
                q.autobotOverrideHostName = c('RTISubscriptionManagerConfig').autobot.host_name;
                q.autobotOverrideHostIp = c('RTISubscriptionManagerConfig').autobot.host_ip;
            }
            var u = new n(o, p, q, r, s),
                v = new m(u);
            this.$RTISubscriptionManager1[o] = u;
            var w = c('ChannelConstants').getSkywalkerArbiterType(o),
                x = c('Arbiter').subscribe(w, function(y, event) {
                    var z = event.obj.length;
                    for (var aa = 0; aa < z; aa++) {
                        var ba = {
                            topic: o,
                            payload: event.obj[aa]
                        };
                        c('ErrorUtils').applyWithGuard(p, this, [ba]);
                    }
                    this.$RTISubscriptionManager10();
                }.bind(this));
            u.setArbiterToken(x);
            this.flush();
            return v;
    ...
    l.prototype.unsubscribe = function(o) {
        !o ? h(0) : void 0;
        if (o in this.$RTISubscriptionManager1) {
            var p = this.$RTISubscriptionManager1[o];
    ...
    l.prototype.unsubscribeAll = function() {
        if (this.isReady()) {
            var o = {
                reset: 't'
            };
            this.$RTISubscriptionManager9.issueRequest('/sub', o, {}, function(p) {});
        }
    };
    l.prototype.flush = function() {
        var o, p = this;
        if (this.isReady() && !this.$RTISubscriptionManager5) {
            var q;
            (function() {
                p.$RTISubscriptionManager5 = true;
                p.$RTISubscriptionManager6 = false;
                var r = [],
                    s = {},
                    t = false;
                p.forEachSubscription(function(x, y) {
                    y.ping();
                    if (y.isDirty()) {
                        var z = 'subscriptions',
                            aa = s[z];
                ...
                if (!t && s.subscriptions && s.subscriptions.length > 0) {
                    var u = [];
                    for (q = 0; q < s.subscriptions.length; q++)
                        if (s.subscriptions[q].state !== i.UNSUBSCRIBE) u.push(s.subscriptions[q]);
                    s.subscriptions = u;
                    p.$RTISubscriptionManager7 = true;
                }
                var v = function(x) {
                    var y = x.data != null;
                    if (this.$RTISubscriptionManager7 && y) this.$RTISubscriptionManager7 = false;
                    for (var z = 0; z < r.length; z++) {
                        ...
                        if (aa.getState() === i.SUBSCRIBE) {
                            ...
                            if (ba !== null) c('ErrorUtils').applyWithGuard(ba, this, [x]);
                        }
                    }
                    this.deleteSubscriptions(function(ca) {
                        return ca.getState() === i.UNSUBSCRIBE && ca.isSent();
                    });
                    this.$RTISubscriptionManager5 = false;
                    if (this.$RTISubscriptionManager6) {
                        this.$RTISubscriptionManager6 = false;
                        this.flush();
                    }
                }.bind(p);
                if (Object.keys(s).length > 0) {
                    var w = {};
                    if (p.$RTISubscriptionManager7) w.reset = 't';
                    p.$RTISubscriptionManager9.issueRequest('/sub', w, s, v);
                } else p.$RTISubscriptionManager5 = false;
            })();
        } else {
            this.$RTISubscriptionManager6 = true;
            if (this.$RTISubscriptionManager9 === null) this.getCurrentSession();
        }
    };
    l.prototype.deleteSubscriptions = function(o) {
        !o ? h(0) : void 0;
        var p = [];
        this.forEachSubscription(function(r, s) {
            if (o.apply(this, [s])) p.push(r);
        });
        for (var q = 0; q < p.length; q++) delete this.$RTISubscriptionManager1[p[q]];
    };
    l.prototype.forEachSubscription = function(o) {
        !o ? h(0) : void 0;
        for (var p in this.$RTISubscriptionManager1)
            if (this.$RTISubscriptionManager1.hasOwnProperty(p)) o.apply(this, [p, this.$RTISubscriptionManager1[p]]);
    };
    l.prototype.getSubscriptions = function() {
        var o = [];
    ...
    l.prototype.isSubscribed = function(o) {
        !o ? h(0) : void 0;
        return o in this.$RTISubscriptionManager1;
    };
    l.prototype.isReady = function() {
        if (this.$RTISubscriptionManager9 && this.$RTISubscriptionManager2 !== null && this.$RTISubscriptionManager2 && this.$RTISubscriptionManager8) return true;
        return false;
    };
    l.prototype.getCurrentSession = function() {
        c('Arbiter').inform(c('ChannelConstants').GET_RTI_SESSION_REQUEST);
    };
    l.prototype.getMaxSubscriptions = function() {
        if (c('RTISubscriptionManagerConfig').config && c('RTISubscriptionManagerConfig').config.hasOwnProperty('max_subscriptions')) {
            return c('RTISubscriptionManagerConfig').config.max_subscriptions;
        } else return j;
    };
    l.prototype.$RTISubscriptionManager10 = function() {
        var o = null,
            p = null;
        if (c('RTISubscriptionManagerConfig').config) {
            o = c('RTISubscriptionManagerConfig').config.www_idle_unsubscribe_min_time_ms;
            p = c('RTISubscriptionManagerConfig').config.www_idle_unsubscribe_times_ms;
        }
        if (!o || !p) return;
        if (c('UserActivity').isActive(o)) return;
        this.forEachSubscription(function(q, r) {
            var s = r.getTopic(),
                t = false;
            if (s.startsWith('gqls/')) {
                var u = s.split('/', 2)[1];
                if (p !== null && typeof p === 'object' && p[u] !== undefined) {
                    t = !c('UserActivity').isActive(p[u]);
                } else t = false;
            }
            if (t) this.unsubscribe(s);
        }.bind(this));
    };

    function m(o) {
        this.$SubscriptionToken1 = o;
    }
    m.prototype.getContext = function() {
        return this.$SubscriptionToken1.getContext();
    };
    m.prototype.unsubscribe = function() {
        l.unsubscribe(this.$SubscriptionToken1.getTopic());
    };

    function n(o, p, q, r, s) {
        this.$SubscriptionData1 = o;
        this.$SubscriptionData2 = p;
        this.$SubscriptionData3 = true;
        this.$SubscriptionData4 = false;
        this.$SubscriptionData5 = i.SUBSCRIBE;
        this.$SubscriptionData6 = null;
        this.$SubscriptionData7 = Date.now();
        if (q) {
            this.$SubscriptionData8 = q;
        } else this.$SubscriptionData8 = {};
        if (r) {
            this.$SubscriptionData9 = r;
        } else this.$SubscriptionData9 = null;
        if (typeof s == 'function') {
            this.$SubscriptionData10 = s;
            this.$SubscriptionData11 = 0;
        } else this.$SubscriptionData10 = function() {
            return true;
        };
    }
    n.prototype.getCreatedTime = function() {
        return this.$SubscriptionData7;
    };
    n.prototype.getTopic = function() {
        return this.$SubscriptionData1;
    };
    n.prototype.getListener = function() {
        return this.$SubscriptionData2;
    };
    n.prototype.getSubscribeCallback = function() {
        return this.$SubscriptionData9;
    };
    n.prototype.getArbiterToken = function() {
        return this.$SubscriptionData6;
    };
    n.prototype.setArbiterToken = function(o) {
        this.$SubscriptionData6 = o;
    };
    n.prototype.isDirty = function() {
        return this.$SubscriptionData3;
    };
    n.prototype.setDirty = function(o) {
        this.$SubscriptionData3 = o;
    };
    n.prototype.ping = function() {
        if (this.$SubscriptionData10()) {
            this.$SubscriptionData11 = 0;
        } else if (this.$SubscriptionData11 <= k) {
            this.$SubscriptionData11++;
        } else {
            var o = this.getState();
    ...
    n.prototype.getState = function() {
        return this.$SubscriptionData5;
    };
    n.prototype.setState = function(o) {
        this.$SubscriptionData5 = o;
    };
    n.prototype.getContext = function() {
        return this.$SubscriptionData8;
    };
    n.prototype.isSent = function() {
        return this.$SubscriptionData4;
    };
    n.prototype.setSent = function(o) {
        this.$SubscriptionData4 = o;
    };
    n.prototype.prepareUnsubscribe = function() {
        this.setState(i.UNSUBSCRIBE);
        this.setDirty(true);
        this.setSent(false);
    };
...
__d('UFIRootRegistry', ['UFIActionTypes', 'UFISharedDispatcher'], (function a(b, c, d, e, f, g) {
    'use strict';
    if (c.__markCompiled) c.__markCompiled();
    var h = {},
        i = {},
    ...
    function m() {
        if (l) return;
        l = c('UFISharedDispatcher').register(function(o) {
            if (o.type == c('UFIActionTypes').INSTANCE.REMOVE) n.cleanupInstance(o.instanceID);
        });
    }
    var n = {
        registerController: function o(p, q, r, s) {
            m();
            h[p] = s;
            i[r] = [].concat(i[r] || [], [q]);
            j[q] = r;
        },
        registerSnowliftID: function o(p) {
            k.push(p);
        },
        isSnowliftNode: function o(p) {
            return k.indexOf(p) >= 0;
        },
        getInstanceIDFromFTEntIdentifier: function o(p) {
            return i[p] || null;
        },
        getFTEntIdentifierFromInstanceID: function o(p) {
            return j[p] || null;
        },
        cleanupInstance: function o(p) {
            var q = j[p],
                r = i[q];
            if (r && r.includes(p)) {
                i[q] = r.filter(function(s) {
                    return s != p;
                });
                if (i[q].length == 0) delete i[q];
            }
            delete j[p];
        },
        cleanupSnowliftNodes: function o() {
...
__d('LiveWWWFeedbackTypedLogger', ['Banzai', 'GeneratedLoggerUtils', 'nullthrows'], (function a(b, c, d, e, f, g) {
    ...
    h.prototype.log = function() {
        c('GeneratedLoggerUtils').log('logger:LiveWWWFeedbackLoggerConfig', this.$LiveWWWFeedbackTypedLogger1, c('Banzai').BASIC);
    };
    h.prototype.logVital = function() {
        c('GeneratedLoggerUtils').log('logger:LiveWWWFeedbackLoggerConfig', this.$LiveWWWFeedbackTypedLogger1, c('Banzai').VITAL);
    };
    ...
    h.prototype.updateData = function(j) {
        this.$LiveWWWFeedbackTypedLogger1 = babelHelpers['extends']({}, this.$LiveWWWFeedbackTypedLogger1, j);
        return this;
    };
    h.prototype.setCommentID = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.comment_id = j;
        return this;
    };
    h.prototype.setEvent = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.event = j;
        return this;
    };
    h.prototype.setIsMSite = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.is_m_site = j;
        return this;
    };
    h.prototype.setMechanism = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.mechanism = j;
        return this;
    };
    h.prototype.setOriginatedLocally = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.originated_locally = j;
        return this;
    };
    h.prototype.setRecipientID = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.recipient_id = j;
        return this;
    };
    h.prototype.setTimeSinceSub = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.time_since_sub = j;
        return this;
    };
    h.prototype.setUpdateType = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.update_type = j;
        return this;
    };
    h.prototype.setVC = function(j) {
        this.$LiveWWWFeedbackTypedLogger1.vc = j;
        return this;
    };
    var i = {
        comment_id: true,
...
__d('UFIFeedbackMutator', ['ClientIDs', 'LiveWWWFeedbackTypedLogger', 'UFIConstants', 'UFIReactionTypes', 'emptyFunction'], (function a(b, c, d, e, f, g) {
    ...
    var h = c('UFIConstants').UFIActionType,
        ...
        j = {
            getHandlerForAction: function k(l) {
                var m;
                return (m = {}, m[h.LIKE_ACTION] = j.handleLike, m[h.SUBSCRIBE_ACTION] = j.handleSubscribe, m[h.DISABLE_COMMENTS] = j.handleCommentsDisabled, m[h.REACTION] = j.handleReaction, m)[l.actiontype] || c('emptyFunction');
            },
            handleLike: function k(l, m, n) {
                var o = m.clientid && c('ClientIDs').isExistingClientID(m.clientid);
                if (n === i.LIVE_SEND || n === i.STREAMING) new(c('LiveWWWFeedbackTypedLogger'))().updateData({
                    event: 'update_view',
                    update_type: 'like',
                    originated_locally: o
                }).log();
                if (o && m.hasviewerliked != l.hasviewerliked) return null;
                l.likecount = m.likecount;
                l.likesentences = m.likesentences;
                if (m.actorid == l.actorforpost) {
                    l.hasviewerliked = m.hasviewerliked;
                } else {
            ...
            handleSubscribe: function k(l, m, n) {
                if (m.clientid && c('ClientIDs').isExistingClientID(m.clientid) && m.hasviewersubscribed != l.hasviewersubscribed) return null;
                if (m.actorid == l.actorforpost) l.hasviewersubscribed = m.hasviewersubscribed;
                return l;
            },
            ...
            handleReaction: function k(l, m, n) {
                if (m.clientid && c('ClientIDs').isExistingClientID(m.clientid) && m.viewerreaction !== l.viewerreaction) return null;
                if (l.reactors && l.actorforpost == m.actorid && l.viewerreaction != m.viewerreaction)
                    if (m.viewerreaction == c('UFIReactionTypes').NONE) {
                        l.reactors = l.reactors.slice(1);
                    } else if (l.viewerreaction == c('UFIReactionTypes').NONE) {
                    l.reactors.unshift({
                        name: l.ownname,
                        profilepicsrc: l.ownprofpic,
                        reaction: m.viewerreaction
                    });
                } else l.reactors[0].reaction = m.viewerreaction;
                if (l.actorforpost == m.actorid || l.viewerreaction == m.viewerreaction) {
                    l.importantreactorids = m.importantreactorids;
...
__d('UFIFeedbackTargets', ['KeyedCallbackManager', 'UFICentralUpdates', 'UFIFeedbackMutator'], (function a(b, c, d, e, f, g) {
    ...
    function i(l) {
        ...
        l.filter(function(n) {
            ...
            delete o.commentlist;
            delete o.commentcount;
            m[n.entidentifier] = o;
            c('UFICentralUpdates').didUpdateFeedback(n.entidentifier);
        });
        h.addResourcesAndExecute(m);
    }
    ...
    c('UFICentralUpdates').subscribe('update-feedback', function(l, m) {
        var n = m.feedbacktargets;
        if (n && n.length) i(n);
    });
    c('UFICentralUpdates').subscribe('update-actions', function(l, m) {
        if (m.actions && m.actions.length) j(m.actions, m.payloadsource);
    });
    f.exports = k;
}), 6);
__d('ImmutableValue', ['invariant', 'isNode', 'keyOf'], (function a(b, c, d, e, f, g, h) {
    ...
    j.deepFreezeRootNode = function(k) {
        ...
        Object.freeze(k);
        for (var l in k)
            if (k.hasOwnProperty(l)) j.recurseDeepFreeze(k[l]);
        Object.seal(k);
    };
...
__d('mergeHelpers', ['invariant', 'keyMirror', 'FbtResult'], (function a(b, c, d, e, f, g, h) {
    ...
    var i = 36,
        j = function l(m) {
            return typeof m !== 'object' || m instanceof Date || m === null || m instanceof c('FbtResult');
        },
        k = {
            MAX_MERGE_DEPTH: i,
            isTerminal: j,
            ...
            checkMergeArrayArgs: function l(m, n) {
                !(Array.isArray(m) && Array.isArray(n)) ? h(0): void 0;
            },
            ...
            checkMergeObjectArg: function l(m) {
                !(!j(m) && !Array.isArray(m)) ? h(0): void 0;
            },
            checkMergeIntoObjectArg: function l(m) {
                !((!j(m) || typeof m === 'function') && !Array.isArray(m)) ? h(0): void 0;
            },
            checkMergeLevel: function l(m) {
                !(m < i) ? h(0): void 0;
            },
            checkArrayStrategy: function l(m) {
                !(m === undefined || m in k.ArrayStrategies) ? h(0): void 0;
            },
...
__d('ImmutableObject', ['invariant', 'ImmutableValue', 'keyOf', 'mergeHelpers'], (function a(b, c, d, e, f, g, h) {
    ...
    var i, j;
    if (c.__markCompiled) c.__markCompiled();
    var k = c('mergeHelpers').checkMergeObjectArgs,
    ...
    function n(q) {
        !(q instanceof c('ImmutableValue')) ? h(0): void 0;
    }
    ...
    o.set = function(q, r) {
        n(q);
        !(typeof r === 'object' && r !== undefined && !Array.isArray(r)) ? h(0): void 0;
        return new o(q, r);
    };
    ...
    o.deleteProperty = function(q, r) {
        var s = {};
        for (var t in q)
            if (t !== r && q.hasOwnProperty(t)) s[t] = q[t];
        return new o(s);
    };
...
__d('MercuryLoggingHelper', [], (function a(b, c, d, e, f, g) {
    ...
    var i = {
        obfuscateThread: function j(k) {
            ...
            if (k && k.snippet && k.snippet.length > 9) l.snippet = h(k.snippet) + '...';
            return l;
        },
        obfuscateMessage: function j(k) {
            var l = babelHelpers['extends']({}, k);
            if (k && k.body && k.body.length > 9) l.body = h(k.body) + '...';
            return l;
        }
    };
    f.exports = i;
}), null);
__d('MercuryServerDispatcher', ['AsyncRequest', 'BanzaiLogger', 'ChatPerfEvent', 'CurrentUser', 'LogHistory', 'MercuryLoggingHelper', 'areJSONRepresentationsEqual', 'debounceAcrossTransitions', 'performanceAbsoluteNow'], (function a(b, c, d, e, f, g) {
    'use strict';
    if (c.__markCompiled) c.__markCompiled();
    var h = {},
            ...
            registerEndpoints: function n(o) {
                for (var p in o) {
                    var q = o[p],
                        ...
                        s = q.endpoint_id || k.DEFAULT_ENDPOINT_ID;
                    if (!h[p]) h[p] = {};
                    if (!h[p][r]) h[p][r] = {};
                    h[p][r][s] = new l(p, q);
                }
    ...
    function l(n, o) {
        ...
        switch (p) {
            ...
            case k.BATCH_CONDITIONAL:
                break;
            default:
                throw new Error('Invalid MercuryServerDispatcher mode ' + p);
        }
        this._endpoint = n;
        this._mode = p;
        ...
        this._batchSizeLimit = o.batch_size_limit;
        this._batches = [];
        this._handler = o.handler;
        this._errorHandler = o.error_handler;
        this._transportErrorHandler = o.transport_error_handler || o.error_handler;
        this._connectionRetries = o.connection_retries || 0;
        this._timeoutHandler = o.timeout_handler;
        this._timeout = o.timeout;
        this._serverDialogCancelHandler = o.server_dialog_cancel_handler || o.error_handler;
    ...
    Object.assign(l.prototype, {
        ...
        trySend: function n(o, p) {
            ...
            if (q == k.IMMEDIATE) {
                this._send(o);
            } else if (q == k.IDEMPOTENT) {
                if (!this._inFlight) this._send(o);
            } else if (q == k.BATCH_SUCCESSIVE || q == k.BATCH_SUCCESSIVE_UNIQUE) {
                if (!this._inFlight) {
                    this._send(o);
                } else this._batchData(o);
            } else if (q == k.BATCH_CONDITIONAL) {
                var r = this._batches[0] && this._batches[0].getData();
                if (this._inFlight && (this._combineDataIf(this._pendingRequestData, o) || this._combineDataIf(r, o))) {
                    this._batchData(o);
                } else this._send(o);
            } else if (q == k.BATCH_DEFERRED_MULTI) {
                this._batchData(o);
                this._deferredSend();
            } else if (q == k.BATCH_SUCCESSIVE_PIGGYBACK_ON_ERROR) {
                this._batchData(o);
        ...
        _send: function n(o) {
            this._inFlight++;
            this._pendingRequestData = babelHelpers['extends']({}, o);
            if (this._requestUserID != c('CurrentUser').getID()) o.request_user_id = this._requestUserID;
            i.log('send', JSON.stringify({
                endpoint: this._endpoint,
                inflight_count: this._inFlight
            }));
            var p = c('performanceAbsoluteNow')(),
                q = new(c('AsyncRequest'))(this._endpoint).setData(o).setOption('retries', this._connectionRetries).setHandler(function(r) {
                    c('BanzaiLogger').log('ChatPerfLoggerConfig', {
                        event: c('ChatPerfEvent').ASYNC_REQUEST,
                        duration: c('performanceAbsoluteNow')() - p,
                        endpoint: this._endpoint
                    });
            ...
            if (this._customHeader) q.setRequestHeader(this._customHeader.name, this._customHeader.value);
            if (this._timeout && this._timeoutHandler) q.setTimeoutHandler(this._timeout, this._handleTimeout.bind(this));
            q.send();
        },
        _batchData: function n(o, p) {
            if (this._mode == k.BATCH_SUCCESSIVE_UNIQUE && this._pendingRequestData !== undefined && c('areJSONRepresentationsEqual')(o, this._pendingRequestData)) {
                return;
            } else {
                var q = this._batches.length - 1;
                if (q >= 0 && !this._hasReachedBatchLimit(this._batches[q])) {
                    p ? this._batches[q].combineWithOlder(o, this._combineData) : this._batches[q].combineWith(o, this._combineData);
                } else this._batches.push(new m(o));
        ...
        _hasReachedBatchLimit: function n(o) {
            return this._batchSizeLimit && o.getSize() >= this._batchSizeLimit;
        },
        ...
        _handleResponse: function n(o) {
            ...
            var p = o.getPayload();
            j = p && p.kill_chat;
            if (j) i.log('killswitch_enabled', JSON.stringify({
                endpoint: this._endpoint,
                inflight_count: this._inFlight
            }));
            if (p && p.error_payload) {
                if (this._errorHandler) this._errorHandler(o);
            } else this._handler && this._handler(p, o.getRequest());
            if (this._mode == k.BATCH_SUCCESSIVE || this._mode == k.BATCH_SUCCESSIVE_UNIQUE || this._mode == k.BATCH_SUCCESSIVE_PIGGYBACK_ON_ERROR || this._mode == k.BATCH_CONDITIONAL) this._batchSend();
        ...
        _postErrorHandler: function n() {
            ...
            var o = this._mode;
            if (o == k.BATCH_SUCCESSIVE || o == k.BATCH_SUCCESSIVE_UNIQUE || o == k.BATCH_CONDITIONAL) {
                this._batchSend();
            } else if (o == k.BATCH_SUCCESSIVE_PIGGYBACK_ON_ERROR)
                if (this._batches[0]) {
        ...
        _handleServerDialogCancel: function n(o) {
            this._serverDialogCancelHandler && this._serverDialogCancelHandler(o);
            this._postErrorHandler();
        }
    });
...
__d('NumberFormat', ['NumberFormatConfig'], (function a(b, c, d, e, f, g) {
    ...
    function j(l, m) {
        if (Math.abs(l).toString().length < c('NumberFormatConfig').minDigitsForThousandsSeparator) return l.toString();
        var n = i('' + l);
    ...
    var k = {
        ...
        formatInteger: function l(m) {
            return j(m, c('NumberFormatConfig').numberDelimiter);
        }
    };
    f.exports = k;
}), null);
__d('UFIReactionStore', ['Arbiter', 'FluxStore', 'UFIActionTypes', 'UFIReactionTypes', 'UFIUIEvents', 'UFIUserActions', 'UFIVideoPlayerRegistry'], (function a(b, c, d, e, f, g) {
    'use strict';
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    ...
    j.prototype.__onDispatch = function(k) {
        switch (k.type) {
            case c('UFIActionTypes').STORY.CHANGE_REACTION:
                c('UFIUserActions').changeReaction(k.contextArgs.ftentidentifier, k.reactionType, {
...
__d('ProfileBrowserLink', ['URI'], (function a(b, c, d, e, f, g) {
    ...
    var h = '/ajax/browser/dialog/',
        i = '/browse/',
        j = function l(m, n, o) {
            return new(c('URI'))(m + n).setQueryData(o);
        },
        k = {
            constructPageURI: function l(m, n) {
                return j(i, m, n);
            },
            constructDialogURI: function l(m, n) {
                return j(h, m, n);
            }
        };
    f.exports = k;
}), null);
__d('ProfileBrowserTypes', [], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = {
        LIKES: 'likes',
...
__d('Tooltip.react', ['React', 'TooltipMixin'], (function a(b, c, d, e, f, g) {
    ...
    var h = c('React').PropTypes,
        i = c('React').createClass({
            ...
            render: function j() {
                if (this.props.display === 'block') return (c('React').createElement('div', this.props, this.props.children));
                return c('React').createElement('span', this.props, this.props.children);
            }
        });
    f.exports = i;
}), null);
__d('UFIBlingItem.react', ['cx', 'fbt', 'React', 'NumberFormat', 'UFIConfig', 'joinClasses'], (function a(b, c, d, e, f, g, h, i) {
    var j, k;
    if (c.__markCompiled) c.__markCompiled();
    ...
    m.prototype.render = function() {
        'use strict';
        var n = c('joinClasses')(this.props.className, this.props.iconClassName, "UFIBlingBoxSprite"),
            o = c('NumberFormat').formatIntegerWithDelimiter(this.props.count, c('UFIConfig').numberDelimiter),
            p = o;
        switch (this.props.itemKey) {
            case 'like':
                p = i._({
                    "Like": "{count} Like",
                    "Likes": "{count} Likes"
                }, [i.param('count', this.props.countreduced && isNaN(this.props.countreduced) ? this.props.countreduced : p), i['enum'](this.props.count === 1 ? 'Like' : 'Likes', {
                    Like: 'Like',
                    Likes: 'Likes'
                })]);
                break;
            case 'comment':
                ...
                }, [i.param('count', this.props.countreduced && isNaN(this.props.countreduced) ? this.props.countreduced : p), i['enum'](this.props.count === 1 ? 'Comment' : 'Comments', {
                    Comment: 'Comment',
                    Comments: 'Comments'
                })]);
                break;
            case 'reaction':
                ...
                }, [i.param('count', this.props.countreduced && isNaN(this.props.countreduced) ? this.props.countreduced : p), i['enum'](this.props.count === 1 ? 'Reaction' : 'Reactions', {
                    Reaction: 'Reaction',
                    Reactions: 'Reactions'
                })]);
                break;
            case 'reshare':
                p = i._({
                    "Share": "{count} Share",
                    "Shares": "{count} Shares"
                }, [i.param('count', this.props.countreduced && isNaN(this.props.countreduced) ? this.props.countreduced : p), i['enum'](this.props.count === 1 ? 'Share' : 'Shares', {
                    Share: 'Share',
                    Shares: 'Shares'
                })]);
                break;
...
__d('UFIBusinessActorIcon.react', ['cx', 'AppUserRoleConstants.brands', 'React', 'joinClasses', 'getObjectValues', 'UnicodeCJK'], (function a(b, c, d, e, f, g, h) {
    var i, j;
    if (c.__markCompiled) c.__markCompiled();
    ...
    function m() {
        ...
        return o = (n = j.constructor).call.apply(n, [this].concat(q)), this.$UFIBusinessActorIcon1 = function(s, t) {
            if (!(typeof s === 'string') || !(typeof t === 'string')) return '?';
            var u = s.trim().charAt(0) + t.trim().charAt(0);
            if (!c('UnicodeCJK').hasIdeograph(u)) {
                u = u.toUpperCase();
            } else u = t.trim().charAt(0);
            return u;
        }, o;
    }
    m.prototype.render = function() {
        'use strict';
        var n = this.$UFIBusinessActorIcon1(this.props.firstName, this.props.lastName),
            o = this.props.businessRole === c('AppUserRoleConstants.brands').ADMIN;
        return c('React').createElement('div', {
            className: c('joinClasses')(this.props.classNames, "_1rpl")
        }, c('React').createElement('div', {
            className: c('joinClasses')(this.props.textClassNames, o ? "_1rpm" : null)
        }, n));
    };
    m.propTypes = {
        firstName: k.string.isRequired,
        lastName: k.string.isRequired,
        classNames: k.string,
        textClassNames: k.string,
        businessRole: k.oneOf(c('getObjectValues')(c('AppUserRoleConstants.brands')))
    };
    f.exports = m;
}), null);
__d('UFICommentLink.react', ['cx', 'fbt', 'React', 'TrackingNodes', 'emptyFunction'], (function a(b, c, d, e, f, g, h, i) {
    var j, k;
    if (c.__markCompiled) c.__markCompiled();
    var l = c('React').PropTypes;
    j = babelHelpers.inherits(m, c('React').Component);
    ...
    m.prototype.render = function() {
        'use strict';
        var n = i._(["Comment", "aebcf8041896e9214d4300b39ec95feb"]),
            o = i._("Leave a comment"),
            p = '{ "tn": "' + c('TrackingNodes').encodeTN(c('TrackingNodes').types.COMMENT_LINK) + '", "type": 24 }';
...
__d('UFILikeLink.react', ['cx', 'fbt', 'Bootloader', 'React', 'ReactDOM', 'TrackingNodes', 'UFILikeWebDriverIDs'], (function a(b, c, d, e, f, g, h, i) {
    var j, k;
    if (c.__markCompiled) c.__markCompiled();
    var l = c('React').PropTypes,
        m = null;
    ...
    function n() {
        ...
        return p = (o = k.constructor).call.apply(o, [this].concat(r)), this.state = {
            nuxShown: false
        }, this.onClick = function(t) {
            if (this.props.href) return;
            t.preventDefault();
            this.props.onClick(t);
            if (this.props.showLikeNuxForGroupMallAds) {
                var u = !this.props.likeAction;
                if (!u) {
                    c('ReactDOM').findDOMNode(this.$UFILikeLink1).focus();
                    this.setState({
                        nuxShown: true
                    });
                    c('Bootloader').loadModules(["UFIGroupMallAdsLikeNux.react"], function(v) {
                        m = v;
                    }, 'UFILikeLink.react');
                } else this.setState({
                    nuxShown: false
        ...
        }.bind(this), this.renderLayers = function() {
            if (!this.state.nuxShown || !m) return null;
            return (c('React').createElement(m, {
                nuxShown: this.state.nuxShown,
                nuxContent: this.props.likeNuxContent,
                contextRef: this.$UFILikeLink1
            }));
        }.bind(this), p;
    }
    n.prototype.render = function() {
        'use strict';
        var o = !this.props.likeAction,
            p = o ? c('UFILikeWebDriverIDs').UNLIKE_LINK : c('UFILikeWebDriverIDs').LIKE_LINK,
            q = !o || !this.props.forcelegacyrendering ? i._("Like") : i._("Unlike"),
            r = c('TrackingNodes').getTrackingInfo(o ? c('TrackingNodes').types.UNLIKE_LINK : c('TrackingNodes').types.LIKE_LINK),
            s = o ? i._("Unlike this") : i._("Like this");
        return (c('React').createElement('span', null, c('React').createElement('a', {
            className: "_48-k" + (' ' + "UFILikeLink") + (o ? ' ' + "UFILinkBright" : ''),
            ref: function(t) {
                return this.$UFILikeLink1 = t;
            }.bind(this),
            'data-testid': p,
            ...
            onKeyDown: function(t, u) {
                this.props.onKeyDown && this.props.onKeyDown(t, u);
            }.bind(this),
            'data-ft': r
        }, q), this.renderLayers()));
    };
    n.propTypes = {
        ...
        likeAction: l.bool,
        rel: l.string,
        forcelegacyrendering: l.bool,
        onClick: l.func,
        showLikeNuxForGroupMallAds: l.bool,
        likeNuxContent: l.string
    };
    n.defaultProps = {
        forcelegacyrendering: false,
        showLikeNuxForGroupMallAds: false
    };
    f.exports = n;
}), null);
__d('UFIShareNowMenuBootloader.react', ['BootloadedComponent.react', 'JSResource', 'React', 'UFIShareLink.react'], (function a(b, c, d, e, f, g) {
    ...
    function j() {
        ...
        return l = (k = i.constructor).call.apply(k, [this].concat(n)), this.state = {
            openOnInit: false,
            focusOnInit: false,
            interacted: false
        }, l;
    ...
    j.prototype.render = function() {
        ...
        var k = this.state,
            ...
            r = o.onShow,
            s = o.onHide,
            t = c('React').createElement(c('UFIShareLink.react'), {
                href: '#',
                onClick: function() {
...
__d('ScrollableArea.react', ['cx', 'Scrollable', 'Bootloader', 'React', 'ReactDOM', 'Style', 'joinClasses'], (function a(b, c, d, e, f, g, h) {
    ...
    var k = c('React').PropTypes,
        ...
        o = "uiScrollableAreaContent";
    i = babelHelpers.inherits(p, c('React').Component);
    j = i && i.prototype;

    function p() {
        var q, r;
        'use strict';
        for (var s = arguments.length, t = Array(s), u = 0; u < s; u++) t[u] = arguments[u];
        return r = (q = j.constructor).call.apply(q, [this].concat(t)), this.getArea = function() {
            return this.$ReactScrollableArea1;
        }.bind(this), this.$ReactScrollableArea2 = function(v) {
            if (this.$ReactScrollableArea4) return;
            this.$ReactScrollableArea1 = v.fromNative(c('ReactDOM').findDOMNode(this.refs.root), {
                fade: this.props.fade,
                persistent: this.props.persistent,
                shadow: this.props.shadow === undefined ? true : this.props.shadow,
                tabIndex: this.props.tabIndex
            });
            this.$ReactScrollableArea3();
            this.props.onScroll && this.$ReactScrollableArea1.subscribe('scroll', this.props.onScroll);
        }.bind(this), this.$ReactScrollableArea3 = function() {
            var v = c('ReactDOM').findDOMNode(this.refs.body);
            c('Style').set(v, 'width', this.props.width + 'px');
        }.bind(this), r;
    }
    p.prototype.render = function() {
        ...
        return c('React').createElement('div', babelHelpers['extends']({}, this.props, {
            ...
            ref: 'root',
            style: babelHelpers['extends']({}, this.props.style || {}, q)
        }), c('React').createElement('div', {
            className: m,
            ref: 'wrap',
            style: {
    ...
    p.prototype.componentDidMount = function() {
        'use strict';
        c('Bootloader').loadModules(["ScrollableArea"], this.$ReactScrollableArea2, 'ScrollableArea.react');
    };
    p.prototype.componentDidUpdate = function(q) {
        'use strict';
        if (q.width !== this.props.width) this.$ReactScrollableArea3();
        var r = this.getArea();
        if (r) r.throttledAdjustGripper();
    };
    p.prototype.componentWillUnmount = function() {
        'use strict';
        this.$ReactScrollableArea1 && this.$ReactScrollableArea1.destroy();
        this.$ReactScrollableArea4 = true;
    };
    p.propTypes = {
        width: k.number,
...
__d('XUICardSection.react', ['cx', 'React', 'XUIBlock', 'joinClasses'], (function a(b, c, d, e, f, g, h) {
    ...
    k.prototype.render = function() {
        var l = c('joinClasses')("_4-u3", c('XUIBlock').getBackgroundClass(this.props));
        return (c('React').createElement('div', babelHelpers['extends']({}, this.props, {
            className: c('joinClasses')(this.props.className, l)
        }), this.props.children));
    };
    ...
    k.propTypes = c('XUIBlock').propTypes;
    k.defaultProps = c('XUIBlock').getDefaultProps();
    f.exports = k;
}), null);
__d('XUIEditButton.react', ['cx', 'fbt', 'XUIAbstractGlyphButton.react', 'React', 'joinClasses'], (function a(b, c, d, e, f, g, h, i) {
    var j, k;
    if (c.__markCompiled) c.__markCompiled();
...
__d('SearchI18nMatch', ['invariant', 'UnicodeHangulKorean', 'UnicodeCJK', 'SearchI18nArabic', 'createObjectFrom', 'mapObject'], (function a(b, c, d, e, f, g, h) {
    'use strict';
    if (c.__markCompiled) c.__markCompiled();
    var i = ['prefix_hangul_conjoining_jamo', 'prefix_kana_drop_trailing_latin', 'prefix_kana_hiragana_to_katakana', 'search_i18n_prefix_arabic_normalization'];

    function j(k) {
        this.config = c('createObjectFrom')(i, false);
        this.setConfigs(k || {});
    }
    j.prototype.setConfigs = function(k) {
        c('mapObject')(k, function(l, m) {
            return this.setConfig(m, l);
        }.bind(this), this);
    };
    j.prototype.setConfig = function(k, l) {
        !(k in this.config) ? h(0): void 0;
        this.config[k] = l;
    };
    j.prototype.prefixMatchPrepare = function(k) {
        if (k) {
            if (this.config.prefix_hangul_conjoining_jamo) k = c('UnicodeHangulKorean').toConjoiningJamo(k);
            if (this.config.prefix_kana_drop_trailing_latin) k = c('UnicodeCJK').kanaRemoveTrailingLatin(k);
            if (this.config.prefix_kana_hiragana_to_katakana) k = c('UnicodeCJK').hiraganaToKatakana(k);
            if (this.config.search_i18n_prefix_arabic_normalization) k = c('SearchI18nArabic').arabicNormalization(k);
        }
        return k;
    };
    j.prototype.prefixMatch = function(k, l) {
...
__d('DataSource', ['ArbiterMixin', 'AsyncRequest', 'TokenizeUtil', 'SearchI18nMatch', 'createArrayFromMixed', 'createObjectFrom', 'emptyFunction', 'mixin', 'str2rstr', 'Map'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    ...
    function j(k) {
        ...
        this._enabledLocalCache = k.enabledLocalCache != null ? k.enabledLocalCache : true;
        this._enabledQueryCache = k.enabledQueryCache != null ? k.enabledQueryCache : true;
        this._disableAllCaches = k.disableAllCaches != null ? k.disableAllCaches : false;
        this._enabledMergeUids = k.enabledMergeUids != null ? k.enabledMergeUids : false;
        ...
        this._enforceNewRequestIDUponFetch = k.enforceNewRequestIDUponFetch || false;
    ...
    j.prototype.bootstrap = function() {
        var k = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
        'use strict';
    ...
    j.prototype.bootstrapWithToken = function() {
        'use strict';
    ...
    j.prototype.query = function(k, l, m, n, o) {
        'use strict';
        this.inform('beforeQuery', babelHelpers['extends']({
            value: k,
            local_only: l,
            exclusions: m,
            time_waited: n
        ...
        var q = this.buildUids(k, [], m),
            r = this.respond(k, q);
        this.value = k;
        this.inform('query', babelHelpers['extends']({
            value: k,
            results: r
        }, o));
        var s = this.tokenizeBackend(k).flatValue;
        if (l || !s || this._isQueryTooShort(s) || !this.queryEndpoint || this.getQueryCache().hasOwnProperty(s) || !this.shouldFetchMoreResults(r)) {
        ...
        this.inform('queryEndpoint', babelHelpers['extends']({
            value: k
        }, o));
        this.fetch(this.queryEndpoint, this.getQueryData(k, q), babelHelpers['extends']({
            value: k,
            exclusions: m
        }, o));
        return true;
    };
    j.prototype._isQueryTooShort = function(k) {
        'use strict';
        return k.length < this._minQueryLength;
    };
    j.prototype._tokenize = function(k, l) {
        'use strict';
        return c('TokenizeUtil').parse(k, l);
    };
    j.prototype.tokenizeBackend = function(k, l) {
        'use strict';
        k = this.backendUnicodeMatch.prefixMatchPrepare(k);
        return this._tokenize(k, l);
    };
    j.prototype.tokenizeCache = function(k, l) {
        'use strict';
        k = this.cacheUnicodeMatch.prefixMatchPrepare(k);
        return this._tokenize(k, l);
    };
    j.prototype.shouldFetchMoreResults = function(k) {
        'use strict';
        return k.length < this._maxResults;
    };
    j.prototype.getQueryData = function(k, l) {
        'use strict';
        var m = babelHelpers['extends']({
            value: k
        }, this.queryData);
        l = l || [];
        if (l.length) m.existing_ids = l.join(',');
        if (this._bootstrapping) m.bsp = true;
        return m;
    };
    j.prototype.setQueryData = function(k, l) {
        'use strict';
        if (l) this.queryData = {};
        Object.assign(this.queryData, k);
        return this;
    };
    j.prototype.setBootstrapData = function(k, l) {
        'use strict';
        if (l) this.bootstrapData = {};
    ...
    j.prototype.addFilter = function(k) {
        'use strict';
        var l = this._filters;
        l.push(k);
        return {
    ...
    j.prototype.clearFilters = function() {
        'use strict';
        this._filters = [];
    };
    j.prototype.notify = function(k, l, m, n) {
        'use strict';
    ...
    j.prototype.respond = function(k, l, m) {
        'use strict';
    ...
    j.prototype.respondWithResults = function(k, l, m) {
        'use strict';
    ...
    j.prototype.processResults = function(k, l, m) {
        'use strict';
    ...
    j.prototype.getUniqueID = function() {
        ...
        while (this._data[k] !== undefined) k = '_' + Math.random().toString(36).substr(2, 9);
        return k;
    };
    j.prototype.fetch = function(k, l, m) {
        'use strict';
        if (!k) return;
        ...
        var n = new(c('AsyncRequest'))().setURI(k).setData(l).setMethod('GET').setReadOnly(true).setAllowCrossPageTransition(this._acrossTransitions).setHandler(function(v) {
            this.fetchHandler(v, m || {});
        }.bind(this));
        if (k === this.queryEndpoint) {
            for (var o = this._headerflags, p = Array.isArray(o), q = 0, o = p ? o : o[typeof Symbol === 'function' ? Symbol.iterator : '@@iterator']();;) {
                var r;
                if (p) {
                    if (q >= o.length) break;
                    r = o[q++];
        ...
        n.setErrorHandler(function(v) {
            return this.asyncErrorHandler(v, m);
        }.bind(this));
    ...
    j.prototype.fetchHandler = function(k, l) {
        'use strict';
        var m = l.value,
            n = l.exclusions;
        if (k.getPayload().requestID !== undefined) l.request_id = k.getPayload().requestID;
        var o = this.getQueryIDs(),
            p = this.tokenizeBackend(m || '').flatValue;
        o[p] = l.request_id;
        if (!m && l.replaceCache) this.localCache = {};
        ...
        if (!m) {
            ...
            if (l.token && k.getPayload().token !== l.token) this.bootstrapWithToken();
        }
    };
    j.prototype.addEntries = function(k, l) {
        ...
        var m = this.processEntries(c('createArrayFromMixed')(k || []), l),
            n = m;
        if (this._enabledMergeUids) n = this.buildUids(l, m);
        if (l) {
            var o = this.getQueryCache(),
                p = this.tokenizeBackend(l).flatValue;
            o[p] = n;
        } else this.fillCache(n);
        return m;
    };
    j.prototype.processEntries = function(k, l) {
        'use strict';
        return k.map(function(m, n) {
            ...
            if (!p) {
                ...
                p.bootstrapped = !l;
                this.setEntry(o, p);
            } else Object.assign(p, m);
            this.processEntry(p, l);
            p.index === undefined && (p.index = n);
            return o;
        }, this);
    };
    j.prototype.processEntry = function(k, l) {
        'use strict';
    };
    j.prototype.getAllEntries = function() {
        'use strict';
        return this._data || {};
    };
    j.prototype.getEntry = function(k) {
        'use strict';
        return this._data[k] || null;
    };
    j.prototype.setEntry = function(k, l) {
        'use strict';
        this._data[k] = l;
    };
    j.prototype.fillCache = function(k) {
        'use strict';
        ...
        k.forEach(function(m) {
            ...
            for (var p = 0, q = o.length; p < q; ++p) {
                var r = o[p];
                if (!l.hasOwnProperty(r)) l[r] = {};
                l[r][m] = true;
            }
        }, this);
    };
    j.prototype.getTextToIndex = function(k) {
        'use strict';
        if (k.textToIndex && !k.needs_update) return k.textToIndex;
        k.needs_update = false;
        k.textToIndex = this.getTextToIndexFromFields(k, this._indexedFields);
        return k.textToIndex;
    };
    j.prototype.getTextToIndexFromFields = function(k, l) {
        'use strict';
        var m = [];
        for (var n = 0; n < l.length; ++n) {
            var o = k[l[n]];
            if (o) m.push(o.join ? o.join(' ') : o);
        }
        return m.join(' ');
    };
    j.prototype.mergeUids = function(k, l, m, n) {
        'use strict';
        ...
        return this.deduplicateByKey(k.sort(this.bootstrapSort.bind(this)).concat(l, m));
    };
    j.prototype.bootstrapSort = function(k, l) {
        'use strict';
        var m = this.getEntry(k),
            n = this.getEntry(l);
        if (m.extended_match !== n.extended_match) return m.extended_match ? 1 : -1;
        if (m.index !== n.index) return m.index - n.index;
        if (m.text.length !== n.text.length) return m.text.length - n.text.length;
        if (m.text === n.text) return m.uid < n.uid ? -1 : 1;
        return m.text < n.text ? -1 : 1;
    };
    j.prototype._checkExtendedMatch = function(k, l) {
        'use strict';
        var m = this._alwaysPrefixMatch ? c('TokenizeUtil').isPrefixMatch : c('TokenizeUtil').isQueryMatch;
        for (var n = 0; n < l.length; ++n) {
            var o = this.getEntry(l[n]);
            o.extended_match = o.tokens ? !m(k, o.text) : false;
        }
    };
    j.prototype.buildUids = function(k, l, m) {
        'use strict';
        if (!l) l = [];
        if (!k) return l;
        if (!m) m = [];
        var n = this.buildCacheResults(k, this.localCache),
            ...
            r = p.filter(function(s) {
                if (q.hasOwnProperty(s) || !this.getEntry(s)) return false;
                for (var t = 0; t < this._filters.length; ++t)
                    if (!this._filters[t](this.getEntry(s), k)) return false;
                return q[s] = true;
            }, this);
        return this.uidsIncludingExact(k, r);
    };
    j.prototype.uidsIncludingExact = function(k, l) {
        'use strict';
        var m = l.length;
        if (m <= this._maxResults || c('str2rstr')(k).length < this._minExactMatchLength) return l;
        for (var n = 0; n < m; ++n) {
            var o = this.getEntry(l[n]);
    ...
    j.prototype.buildData = function(k) {
        'use strict';
        var l = [],
            m = Math.min(k.length, this._maxResults);
        for (var n = 0; n < m; ++n) l.push(this.getEntry(k[n]));
        return l;
    };
    j.prototype.findBestPreviousQuery = function(k, l) {
        'use strict';
        var m = 0,
            n = null;
        if (this._queryExactMatch) return l.hasOwnProperty(k) ? k : null;
        for (var o in l)
    ...
    j.prototype.buildCacheResults = function(k, l) {
        'use strict';
        var m = this.tokenizeCache(k, this._alwaysPrefixMatch),
            n = this._alwaysPrefixMatch ? m.sortedTokens : m.tokens,
            o = n.length,
        ...
        for (var x = 0; x < o; ++x) {
            ...
            for (var z in l)
                if (!q.hasOwnProperty(z) && z === y || (this._alwaysPrefixMatch || p === x) && this.cacheUnicodeMatch.prefixMatch(z, y)) {
                    if (z === y) {
                        if (r.hasOwnProperty(z)) u = true;
                        q[z] = true;
                    } else {
                        if (q.hasOwnProperty(z) || r.hasOwnProperty(z)) u = true;
                        r[z] = true;
                    }
                    for (var aa in l[z])
                        if (x === 0 || s.hasOwnProperty(aa) && s[aa] == w - 1) s[aa] = w;
                }
        }
        for (var ba in s)
            if (s[ba] == w) t.push(ba);
        if (u || w < o) t = this.filterQueryResults(k, t);
        if (this._titleFields && this._titleFields.length > 0) t = this.filterNonTitleMatchQueryResults(k, t);
        return t;
    };
    j.prototype.filterNonTitleMatchQueryResults = function(k, l) {
        'use strict';
        return l.filter(function(m) {
            ...
            var p = this.getTitleTerms(this.getEntry(m)),
                q = n.tokens[0];
            return o === 1 || this._alwaysPrefixMatch ? c('TokenizeUtil').isPrefixMatch(q, p) || this.cacheUnicodeMatch.prefixMatch(p, q) : c('TokenizeUtil').isQueryMatch(q, p);
        }, this);
    };
    j.prototype.getTitleTerms = function(k) {
        'use strict';
        if (!k.titleToIndex) k.titleToIndex = this.getTextToIndexFromFields(k, this._titleFields);
        return k.titleToIndex;
    };
    j.prototype.deduplicateByKey = function(k) {
        'use strict';
        if (!this._deduplicationKey) return k;
        var l = c('createObjectFrom')(k.map(this._getDeduplicationKey.bind(this)), k);
        return k.filter(function(m) {
            return l[this._getDeduplicationKey(m)] == m;
        }.bind(this));
    };
    j.prototype._getDeduplicationKey = function(k) {
        'use strict';
    ...
    j.prototype.getQueryCache = function() {
        'use strict';
        return this.queryCache;
    };
    j.prototype.getQueryIDs = function() {
        'use strict';
        return this.queryIDs;
    };
    j.prototype.setMaxResults = function(k) {
        'use strict';
        this._maxResults = k;
        this.value && this.respond(this.value, this.buildUids(this.value));
    };
    j.prototype.getMaxResults = function() {
        'use strict';
        return this._maxResults;
    };
    j.prototype.updateToken = function(k) {
        'use strict';
        this.token = k;
        this.dirty();
        return this;
    };
    j.prototype.getResponseHeaderValue = function(k) {
        'use strict';
        var l = '';
        if (this.transport) {
    ...
    j.prototype._guid = function() {
        'use strict';
        var k = Date.now(),
            l = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function(m) {
...
__d('OnVisible', ['Arbiter', 'DOM', 'Event', 'Parent', 'Run', 'Vector', 'ViewportBounds', 'coalesce', 'queryThenMutateDOM'], (function a(b, c, d, e, f, g) {
    ...
    function r() {
        ...
        for (var w = 0; w < h.length; ++w) {
            var x = h[w];
            if (isNaN(x.elementHeight)) k.push(w);
            ...
            if (x.scrollArea) {
                x.scrollAreaHeight = c('Vector').getElementDimensions(x.scrollArea).y;
        ...
        for (var w = Math.min(h.length, j) - 1; w >= 0; --w) {
            ...
            if (y > x.elementPos.y) {
                var aa = n + p - x.buffer,
                    ...
                    da = !x.strict || aa < x.elementPos.y && ba > ca;
                z = da;
                if (z && x.scrollArea) {
                    var ea = x.scrollAreaY + x.scrollAreaHeight + x.buffer;
                    z = x.elementPos.y >= x.scrollAreaY - x.buffer && x.elementPos.y < ea;
                }
            }
            if (x.inverse ? !z : z) {
                x.remove();
...
__d('linkifyEntityRange', ['Link.react', 'React'], (function a(b, c, d, e, f, g) {
    ...
    function h(i, j) {
        var k = (j.entity || {}).url;
        if (!k) return c('React').createElement('span', null, i);
...
__d('ReactComposerLoggingQueue', ['invariant', 'Bootloader', 'requireWeak'], (function a(b, c, d, e, f, g, h) {
    ...
    var j = [],
        k = {
            add: function l(m) {
                !(m && m.composerID) ? h(0): void 0;
                if (i && i.isActivated(m.composerID)) return;
                j.push(m);
            },
            initBootload: function l(m, n, o, p) {
                c('Bootloader').loadModules(["ComposerXSessionIDs", "ComposerXMarauderLogger", "ReactComposerPerfLogger", "ReactComposerLoggingStore"], function(q, r, s, t) {
                    q.resetSessionID(m);
                    r.registerComposer(n, o, p);
                    s.registerComposer(n, p.targetType, p.ref, o);
                    t.activate(m);
...
__d('ReactComposerDispatcher', ['ReactComposerLoggingQueue', 'Dispatcher_DEPRECATED'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
...
__d('ReactComposerEvents', [], (function a(b, c, d, e, f, g) {
    ...
    var h = {
        ...
        SET_DRAFT_MODE: 'reactComposer/setDraftMode/',
        LOAD_DRAFT: 'reactComposer/loadDraft/'
    };
    f.exports = h;
}), null);
...
__d('ReactComposerAttachmentActions', ['ReactComposerAttachmentActionType', 'ReactComposerDispatcher', 'ReactComposerAttachmentStore'], (function a(b, c, d, e, f, g) {
    ...
    h.prototype.selectAttachment = function(i, j) {
        var k = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2],
            l = arguments[3];
        'use strict';
        var m = c('ReactComposerAttachmentStore').getSelectedAttachmentID(i);
        if (!m) return;
        var n = {
            composerID: i,
...
__d('ReactComposerInit', ['invariant', 'ReactComposerEvents', 'Arbiter', 'ReactComposerIDGenerator', 'Map', 'React', 'ReactDOM'], (function a(b, c, d, e, f, g, h) {
    ...
    var i = {
        ...
        normalizeComposerID: function j(k) {
            if (!k.contextConfig.composerID) k.contextConfig.composerID = c('ReactComposerIDGenerator').getID();
            return k.contextConfig.composerID;
        },
        init: function j(k, l, m) {
            var n = i.normalizeComposerID(l);
            c('ReactDOM').render(c('React').createElement(k, l), m);
            i.instances.set(n, {
                ComposerModule: k,
                props: l,
                container: m
        ...
        resetComposer: function j(k) {
            var l = i._unmountReact(k);
            l.props.contextConfig.composerID = c('ReactComposerIDGenerator').getID();
            l.props.prefillConfig = {};
            i.init(l.ComposerModule, l.props, l.container);
            c('Arbiter').inform(c('ReactComposerEvents').COMPOSER_RESET + k, {
...
__d('ReactComposerStore', ['ReactComposerActionStore', 'ReactComposerActionTypes', 'ReactComposerSproutsDisplayState', 'ReactComposerAttachmentActionType', 'ReactComposerScrapedAttachmentActionType', 'ReactComposerInit', 'Bootloader'], (function a(b, c, d, e, f, g) {
    ...
    j.prototype.$ReactComposerStore1 = function(k) {
        'use strict';
        var l = this.validateAction(k, ['composerID', 'loggingConfig', 'activateOnInit']),
            m = l[0],
            n = l[1],
            o = l[2],
    ...
    j.prototype.$ReactComposerStore6 = function(k) {
        'use strict';
        var l = this.getComposerData(k);
        if (!l.isActive) {
            l.isActive = true;
            c('Bootloader').loadModules(["curry", "Run", "ReactComposerHandleUnsavedChanges", "URI"], function(m, n, o, p) {
                return (n.onBeforeUnload(m(o.handler, k, p.getNextURI())));
            }, 'ReactComposerStore');
        }
    };
    j.prototype.__cleanup = function(k) {
...
__d('ReactComposerLoggingActions', ['ReactComposerActionTypes', 'ReactComposerDispatcher', 'ReactComposerFeatureType', 'ReactComposerLoggingName', 'ReactComposerMediaUploadActionType'], (function a(b, c, d, e, f, g) {
    ...
    var h = {
        ...
        mediaUploadInputClicked: function i(j, k) {
            c('ReactComposerDispatcher').dispatch({
                composerID: j,
        ...
        mediaUploadInputDone: function i(j, k) {
            c('ReactComposerDispatcher').dispatch({
                composerID: j,
...
__d('StoreBasedStateMixinHelper', ['invariant', 'SubscriptionsHandler'], (function a(b, c, d, e, f, g, h) {
    ...
    function i(j) {
        this.$StoreBasedStateMixinHelper1 = j;
        this.$StoreBasedStateMixinHelper2 = new(c('SubscriptionsHandler'))();
    }
    i.prototype.subscribeCallback = function(j) {
        var k = this.$StoreBasedStateMixinHelper1.map(function(l) {
        ...
        if (this.$StoreBasedStateMixinHelper1.length > 0) this.$StoreBasedStateMixinHelper2.addSubscriptions.apply(this.$StoreBasedStateMixinHelper2, k);
    };
        ...
        return {
            ...
            getInitialState: function n() {
                ...
                if (this.constructor.getAttachmentInitialState) {
                    o = this.constructor.getAttachmentInitialState(this.context.composerID, this.props, this.context);
                } else o = {};
                ...
                return Object.assign({}, o, this.constructor.calculateState(this.context.composerID, this.props, this.context));
            },
            componentWillMount: function n() {
                ...
                var o = function(p) {
                    ...
                    if (this.isMounted() && p.composerID === this.context.composerID) this.setState(this.constructor.calculateState(this.context.composerID, this.props, this.context));
                    this._recalculateStateID = null;
                }.bind(this);
                this._mixin = new(c('StoreBasedStateMixinHelper'))(l);
                this._mixin.subscribeCallback(function(p) {
                    if (this._recalculateStateID === null) this._recalculateStateID = c('setImmediate')(o, p);
                }.bind(this));
            },
            componentWillReceiveProps: function n(o) {
                var p = void 0;
                if (this.constructor.getAttachmentWillReceivePropsState) p = this.constructor.getAttachmentWillReceivePropsState(this.context.composerID, o, this.props, this.context);
                this.setState(Object.assign({}, p || {}, this.constructor.calculateState(this.context.composerID, o, this.context)));
            },
    ...
    var h = -400,
        ...
        j = {
            handler: function k(l, m) {
                var n = c('Event').listen(window, 'scroll', c('throttle')(function() {
...
__d('ReactComposerFocusInit', ['invariant', 'DOM', 'DOMContainer.react', 'React', 'ReactDOM'], (function a(b, c, d, e, f, g, h) {
    'use strict';
    if (c.__markCompiled) c.__markCompiled();
    var i = {
        handler: function j(k, l, m, n, o) {
            var p = c('DOM').create('div'),
                q = k.parentNode;
            c('ReactDOM').render(c('React').createElement(o, {
                composerID: l,
                actorID: m,
                gks: n,
...
__d('ReactComposerFocusWrapperCore.react', ['cssVar', 'cx', 'fbt', 'ix', 'ReactComposerEvents', 'Arbiter', 'Event', 'Image.react', 'Keys', 'ReactComponentWithPureRenderMixin', 'React', 'ReactDOM', 'ReactComposerFocusActions', 'Run', 'SubscriptionsHandler'], (function a(b, c, d, e, f, g, h, i, j, k) {
    if (c.__markCompiled) c.__markCompiled();
    var l = c('React').PropTypes,
        m = parseInt("10px", 10),
        n = c('React').createClass({
            displayName: 'ReactComposerFocusWrapperCore',
            _composerID: '',
            _fixedHeight: 0,
            ...
            propTypes: {
                ...
                onDismiss: l.func.isRequired,
                onFocus: l.func.isRequired,
                focused: l.bool.isRequired,
                onFirstFocus: l.func,
                fixHeight: l.bool
            },
            ...
            componentWillMount: function o() {
                this._composerID = this.props.composerID;
            },
            componentWillReceiveProps: function o(p) {
                if (this.props.fixHeight && !this.props.focused && p.focused) {
                    var q = c('ReactDOM').findDOMNode(this.refs.container);
                    this._fixedHeight = q.offsetHeight + m;
                }
            },
            componentDidMount: function o() {
                this._subscriptions = new(c('SubscriptionsHandler'))();
                this._subscriptions.addSubscriptions(c('Event').listen(document.body, 'keydown', function(p) {
                    if (p.keyCode === c('Keys').ESC) this._onDismiss();
                }.bind(this)));
                this._subscribeComposerEvents();
                c('Run').onLeave(this._onDismiss);
            },
            componentDidUpdate: function o(p) {
                if (!p.focused && this.props.focused) try {
                    var q = document.createEvent('HTMLEvents');
                    if (q.initEvent) {
                        q.initEvent('resize', true, false);
                        window.dispatchEvent(new(c('Event'))('resize'));
                    }
                } catch (q) {}
            },
            componentWillUnmount: function o() {
                this._subscriptions && this._subscriptions.release();
                this._onDismiss();
            },
            render: function o() {
                var p = this.props.fixHeight && this.props.focused ? {
                        height: this._fixedHeight
                    } : null,
                    q = this.props.focused ? this._renderDismissButton() : null;
                return (c('React').createElement('div', {
                    className: "_3u13" + (this.props.focused ? ' ' + "_3u14" : ''),
                    style: p
                }, c('React').createElement('div', {
                    className: "_3u15",
                ...
                }, this.props.children, q)));
            },
            getComposerID: function o() {
                return this._composerID;
            },
            getComposer: function o() {
                return this.refs.container;
            },
            _renderDismissButton: function o() {
                return (c('React').createElement('div', {
                    className: "_3u17",
                    onClick: this._onDismiss
                }, c('React').createElement(c('Image.react'), {
                    alt: j._("Close"),
                    src: k('/images/composer/exit.png')
                })));
            },
            _subscribeComposerEvents: function o() {
                var p = c('Arbiter').subscribe(c('ReactComposerEvents').POST_SUCCEEDED + this._composerID, function() {
                        return this.props.onDismiss(true);
                    }.bind(this)),
                    q = c('Arbiter').subscribe('ReactFeedComposerXBootloader/focuscomposer/' + this._composerID, function() {
                        return this._onFocus();
                    }.bind(this)),
                    r = c('Arbiter').subscribe(c('ReactComposerEvents').COMPOSER_RESET + this._composerID, function(s, t) {
                ...
                this._subscriptions.addSubscriptions(p, q, r);
            },
            _onFocus: function o() {
...
__d('ReactComposerFocusInline.react', ['ReactComposerFocusHandleScrollAway', 'ReactComposerFocusWrapperCore.react', 'React', 'ReactDOM'], (function a(b, c, d, e, f, g) {
    var h, i;
    if (c.__markCompiled) c.__markCompiled();
    ...
    function k() {
        ...
        return m = (l = i.constructor).call.apply(l, [this].concat(o)), this.state = {
            focused: false
        }, this.$ReactComposerFocusInline2 = function() {
            var q = c('ReactDOM').findDOMNode(this.refs.focus.getComposer());
            c('ReactComposerFocusHandleScrollAway').handler(q, this.$ReactComposerFocusInline1);
            this.setState({
                focused: true
            });
        }.bind(this), this.$ReactComposerFocusInline1 = function() {
            this.setState({
                focused: false
            });
        }.bind(this), m;
    ...
    k.prototype.componentWillUnmount = function() {
        'use strict';
        this.$ReactComposerFocusInline1();
    };
    k.prototype.render = function() {
        'use strict';
        return c('React').createElement(c('ReactComposerFocusWrapperCore.react'), {
            composerID: this.props.composerID,
            focused: this.state.focused && this.props.enableFocusBehavior,
            onFocus: this.$ReactComposerFocusInline2,
            onDismiss: this.$ReactComposerFocusInline1,
            ref: 'focus'
        }, this.props.children);
    };
    k.propTypes = {
...
__d('ReactComposerConfig', ['ComposerEntryPointRef', 'ComposerTargetData', 'ComposerTargetType', 'ComposerSourceSurface', 'React', 'getObjectValues'], (function a(b, c, d, e, f, g) {
    ...
    f.exports = h.shape({
        ...
        instagramCrossPostingEnabled: h.bool
    });
}), null);
__d('UFIReactionIconImpl.react', ['cx', 'Image.react', 'React', 'UFIReactionTypes', 'joinClasses'], (function a(b, c, d, e, f, g, h) {
    var i, j;
    if (c.__markCompiled) c.__markCompiled();
    var k = c('React').PropTypes;
    ...
    l.prototype.shouldComponentUpdate = function(m, n) {
        'use strict';
        return (m.className !== this.props.className || m.reaction !== this.props.reaction || m.size !== this.props.size || m.grayscale !== this.props.grayscale);
    };
    l.prototype.renderImage = function() {
        'use strict';
        ...
        } else return (c('React').createElement('i', {
            className: c('joinClasses')(c('UFIReactionTypes').reactions[this.props.reaction].class_name, "_2p78" + (this.props.size === '13' ? ' ' + "_9-y" : '') + (this.props.size === '16' ? ' ' + "_9--" : '') + (this.props.size === '48' ? ' ' + "_9-_" : '') + (this.props.size === '96' ? ' ' + "_9_0" : '') + (this.props.grayscale ? ' ' + "_pxi" : ''))
        }));
    };
    l.prototype.render = function() {
        'use strict';
        return (c('React').createElement('span', {
            className: c('joinClasses')("_9zc" + (this.props.size === '13' ? ' ' + "_2p79" : '') + (this.props.size === '16' ? ' ' + "_2p7a" : '') + (this.props.size === '48' ? ' ' + "_2p7b" : '') + (this.props.size === '96' ? ' ' + "_9-w" : ''), this.props.className)
        }, this.renderImage()));
    };
...
__d('VideoDashPrefetchCache', ['Promise', 'getCrossOriginTransport', 'Deferred', 'Map', 'Run', 'URI', 'VideoPlayerShakaExperiments', 'XHRRequest'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = null;

    function i(m, n) {
        var o = new Error(m.errorMsg);
        o.name = m.errorType;
        o.type = 'preload';
        o.url = n;
        o.status = m.errorCode;
        return o;
    }

    function j(m) {
        var n = new(c('URI'))(m.url),
            o = n.getDomain();
        return o.endsWith('fbcdn.net') && !o.startsWith('interncache') && !o.endsWith('ak.fbcdn.net');
    }

    function k(m, n, o) {
        return {
            response: m.slice(n.start + 0, n.end + 1),
            responseTime: o
        };
    }
    ...
    function l() {
        'use strict';
        this.$VideoDashPrefetchCache1 = new(c('Map'))();
        this.$VideoDashPrefetchCache2 = [];
        this.$VideoDashPrefetchCache3 = [];
        this.$VideoDashPrefetchCache4 = 0;
        this.$VideoDashPrefetchCache5 = c('VideoPlayerShakaExperiments').maxPrefetchVideosNum;
        this.$VideoDashPrefetchCache6 = c('VideoPlayerShakaExperiments').consolidateFragmentedPrefetchRequest;
    }
    l.prototype.$VideoDashPrefetchCache7 = function(m) {
        'use strict';
        var n = new(c('XHRRequest'))(m).setMethod('GET').setResponseType('arraybuffer').setTransportBuilder(c('getCrossOriginTransport')),
            o = new(c('Promise'))(function(p, q) {
                n.setErrorHandler(function(r) {
                    this.$VideoDashPrefetchCache8(n);
                    q(i(r, m));
                }.bind(this));
                n.setResponseHandler(function(r) {
                    n.response = r;
                    this.$VideoDashPrefetchCache8(n);
                    p(n);
                }.bind(this));
                n.setAbortHandler(function() {
                    q(o, new Error('Request promise aborted'));
                });
            }.bind(this));
        this.$VideoDashPrefetchCache9(m, o);
        this.$VideoDashPrefetchCache2.push(n);
        n.send();
        return o;
    };
    l.prototype.$VideoDashPrefetchCache10 = function(m) {
        'use strict';
        var n = [];
        for (var o = 0; o < m.length; o++) {
            var p = l.createQueryStringURL(m[o]);
            if (!this.has(p)) n.push(this.$VideoDashPrefetchCache7(p));
        }
        return n;
    };
    l.prototype.$VideoDashPrefetchCache11 = function(m) {
        'use strict';
        var n = l.getConsolidatedURL(m);
        if (n == null) return this.$VideoDashPrefetchCache10(m);
        var o = new(c('XHRRequest'))(n).setMethod('GET').setResponseType('arraybuffer').setTransportBuilder(c('getCrossOriginTransport')),
            p = Date.now(),
            q = [];
        for (var r = 0; r < m.length; r++) {
            var s = l.createQueryStringURL(m[r]),
                t = new(c('Deferred'))();
            if (!this.has(s)) this.$VideoDashPrefetchCache9(s, t.getPromise());
            q.push(t);
        }
        o.setErrorHandler(function(u) {
            this.$VideoDashPrefetchCache8(o);
            for (var v = 0; v < q.length; v++) q[v].reject(i(u, n));
        }.bind(this));
        o.setResponseHandler(function(u) {
            var v = Date.now() - p;
        ...
        o.setAbortHandler(function() {
            for (var u = 0; u < m.length; u++) {
                var v = q[u];
                v.reject(new Error('Request aborted.'));
            }
        });
        this.$VideoDashPrefetchCache2.push(o);
        o.send();
        return q.map(function(u) {
            return u.getPromise();
        });
    };
    l.prototype.$VideoDashPrefetchCache12 = function(m) {
        'use strict';
        this.$VideoDashPrefetchCache4++;
        var n = this.$VideoDashPrefetchCache6 ? this.$VideoDashPrefetchCache11(m.video) : this.$VideoDashPrefetchCache10(m.video),
            o = this.$VideoDashPrefetchCache6 ? this.$VideoDashPrefetchCache11(m.audio) : this.$VideoDashPrefetchCache10(m.audio),
            p = this.$VideoDashPrefetchCache10(m.manifest),
            q = n.concat(o, p);
        c('Promise').all(q).then(function() {
            return this.$VideoDashPrefetchCache13();
        }.bind(this))['catch'](function() {
            return this.$VideoDashPrefetchCache13();
        }.bind(this));
    };
    l.prototype.$VideoDashPrefetchCache9 = function(m, n) {
        'use strict';
        if (this.$VideoDashPrefetchCache1.values().next().done) c('Run').onLeave(function() {
            for (var o = 0; o < this.$VideoDashPrefetchCache2.length; o++) this.$VideoDashPrefetchCache2[o].abort();
            this.$VideoDashPrefetchCache2 = [];
            this.$VideoDashPrefetchCache3 = [];
            this.$VideoDashPrefetchCache4 = 0;
            this.$VideoDashPrefetchCache1.clear();
        }.bind(this));
        this.$VideoDashPrefetchCache1.set(m, n);
    };
    l.prototype.$VideoDashPrefetchCache8 = function(m) {
        'use strict';
        var n = this.$VideoDashPrefetchCache2.indexOf(m);
        if (n > -1) this.$VideoDashPrefetchCache2.splice(n, 1);
    };
    l.prototype.$VideoDashPrefetchCache13 = function() {
        'use strict';
        this.$VideoDashPrefetchCache4--;
        var m = this.$VideoDashPrefetchCache3.shift();
        if (m) this.$VideoDashPrefetchCache12(m);
    };
    l.prototype.has = function(m) {
        'use strict';
        return this.$VideoDashPrefetchCache1.has(m);
    };
    l.prototype.getAndDelete = function(m) {
        'use strict';
        var n = this.$VideoDashPrefetchCache1.get(m);
        this.$VideoDashPrefetchCache1['delete'](m);
        return n;
    };
    l.prototype.queueRequestBatch = function(m) {
        'use strict';
        if (this.$VideoDashPrefetchCache5 === 0 || this.$VideoDashPrefetchCache4 < this.$VideoDashPrefetchCache5) {
            this.$VideoDashPrefetchCache12(m);
        } else this.$VideoDashPrefetchCache3.push(m);
    };
    ...
    l.createQueryStringURL = function(m) {
        'use strict';
        var n = m.url,
            o = m.start,
            p = m.end;
        if (o !== null && o !== undefined && p !== null && p !== undefined) n = new(c('URI'))(n).addQueryData({
            bytestart: o,
            byteend: p
        });
        return n.toString();
    };
    l.getConsolidatedURL = function(m) {
        'use strict';
        var n = '',
            o = Infinity,
            p = 0;
        for (var q = 0; q < m.length; q++) {
            ...
            if (n === '') {
                n = s;
            } else if (n !== s) return null;
            o = Math.min(o, t);
            p = Math.max(p, u);
        }
        return l.createQueryStringURL({
            url: n,
            start: o,
            end: p
        });
    };
    l.loadVideo = function(m) {
        'use strict';
        var n = l.getInstance();
        if (!m.manifest) m.manifest = [];
        n.queueRequestBatch({
            manifest: m.manifest.filter(j),
            video: m.video.filter(j),
            audio: m.audio.filter(j)
        });
    };
    l.getCacheValue = function(m) {
        'use strict';
        return l.getInstance().getAndDelete(m);
    };
    f.exports = l;
}), null);
    ...
    var h = {},
        ...
        j = {
            ...
            register: function k(l, m) {
                var n = l.id;
                h[n] = c('Event').listen(l, 'click', function() {
                    if (m) {
                        c('CSS').hide(l);
                        c('CSS').show(m);
                    }
                ...
                if (m) h[n + i] = c('Event').listen(m, 'click', function() {
                    c('CSS').hide(m);
                    c('CSS').show(l);
            ...
            unregister: function k(l) {
                var m = l.id;
                if (h.hasOwnProperty(m)) h[m].remove();
                var n = m + i;
                if (h.hasOwnProperty(n)) h[n].remove();
            }
        };
    f.exports = j;
}), null);
__d('VideosRenderingInstrumentation', ['DataStore', 'VideoPlayerHTML5Experiments', 'performanceAbsoluteNow'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = {
        storeRenderTime: function i(j) {
            var k = c('VideoPlayerHTML5Experiments').useMonotonicallyIncreasingTimers ? c('performanceAbsoluteNow')() : Date.now();
            c('DataStore').set(j, 'videos_rendering_instrumentation', k);
            return k;
        },
        retrieveRenderTime: function i(j) {
            var k = c('DataStore').get(j, 'videos_rendering_instrumentation', NaN);
            if (Number.isNaN(k)) k = h.storeRenderTime(j);
            return k;
        }
    };
    f.exports = h;
...
__d('StreamingReactionsTrayEvents', [], (function a(b, c, d, e, f, g) {
    ...
    var h = 'streamingReactionsTray/AddReactionAnimate',
        ...
        l = 'streamingReactionsTray/ResizeChannelViewWindow',
...
__d('onViewportChanged', ['EventListener', 'emptyFunction', 'getViewportDimensions', 'requestAnimationFrame'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = [],
        i = false,
        j = null,
    ...
    function m() {
        var x = c('getViewportDimensions').withoutScrollbars();
        return {
            top: 0,
            bottom: x.height,
            left: 0,
    ...
    function n(x, y) {
        var z = {
            transform: y || c('emptyFunction').thatReturnsArgument,
            callback: x,
            needsUpdate: true
        };
        h.push(z);
        ...
        p();
        return {
            remove: o.bind(null, z),
            scheduleCheck: s.bind(null, z)
        };
    }
    ...
    function p() {
        if (!l) {
            l = c('EventListener').listen(window, 'scroll', t);
            k = c('EventListener').listen(window, 'resize', r);
        }
    }
    ...
    function w() {
        ...
        var x = h.filter(v),
            y = x.map(function(z) {
                return z.transform.call(null, j);
            });
        x.forEach(function(z, aa) {
            return z.callback.call(null, y[aa]);
        });
    }
    f.exports = n;
}), null);
__d('onRectIsWithinViewport', ['onViewportChanged'], (function a(b, c, d, e, f, g) {
    ...
    function h(j, k) {
        return !(j.bottom < k.top || j.top > k.bottom || j.right < k.left || j.left > k.right);
    }
...
__d('OnVisible.react', ['React', 'ReactDOM', 'getElementRect', 'onRectIsWithinViewport'], (function a(b, c, d, e, f, g) {
    if (c.__markCompiled) c.__markCompiled();
    var h = c('React').PropTypes,
        i = c('React').createClass({
            ...
            check: function j() {
                if (this._listener) this._listener.scheduleCheck();
            },
            _measureElementRect: function j() {
                if (!this.isMounted()) return null;
                var k = this.props.buffer || 0,
                    l = c('getElementRect')(c('ReactDOM').findDOMNode(this));
                l.left -= k;
                l.right += k;
                l.top -= k;
                l.bottom += k;
            ...
            _createListener: function j() {
                ...
                if (this._listener && k !== this._element) this._removeListener();
                if (!this._listener) {
                    this._element = k;
                    this._listener = c('onRectIsWithinViewport')(this._measureElementRect, function(l) {
    ...
    var h = 10000,
        i = {
            subscribe: function j(k, l) {
                ...
                return c('RTISubscriptionManager').subscribe(this._getTopic(k), function(o) {
            ...
            _logEvent: function j(k, l) {
                if (c('Banzai').isEnabled('gqls_web_logging')) {
                    var m = c('CurrentUser').isEmployee() ? 1 : h;
...
__d('ContentTranslationStrings', ['fbt', 'TranslationRating'], (function a(b, c, d, e, f, g, h) {
    if (c.__markCompiled) c.__markCompiled();
    var i = {
        SEE_TRANSLATION: h._("See Translation"),
        SEE_TRANSLATION_TIP: h._("Translate this comment"),
        NO_TRANSLATION_AVAILABLE: h._("No translation available"),
        AUTOMATICALLY_TRANSLATED: h._("Automatically Translated"),
        HIDE_ORIGINAL: h._("Hide original"),
        SEE_ORIGINAL: h._("See original"),
        SEE_ORIGINAL_LINK: h._("See Original"),
        UNDO: h._("Undo"),
        CANCEL: h._("Cancel"),
        SUBMIT: h._("Submit"),
        DONE: h._("Done"),
        CLOSE: h._("Close"),
        SEARCH: h._("Search"),
        ENTER_TRANSLATION: h._("Enter your translation"),
        EDIT_TRANSLATION_THANKS: h._("Thank you! Your feedback helps us improve our translation quality."),
        EDIT_TRANSLATION_DIALOG_TITLE_NORMAL: h._("Edit Translation"),
        EDIT_TRANSLATION_DIALOG_TITLE_ERROR: h._("Submission Unsuccessful"),
        EDIT_TRANSLATION_ERROR: h._("There was a problem with the submission. Please try again later. Thanks for the good work!"),
        EDIT_TRANSLATION_MENU: h._("I have a better translation"),
        RATE_TRANSLATION: h._("Rate this translation"),
        I_DONT_KNOW: h._("I don't know"),
        NO_MATCHING_LANGUAGES: h._("No matching languages"),
        LANGUAGE_SETTINGS: h._("Language settings"),
        CLICK_TO_RATE: h._("Click a star to rate"),
        TAP_TO_RATE: h._("Tap a star to rate"),
        ORIGINAL_TEXT: h._("Original text:"),
        YOUR_TRANSLATION: h._("Your translation:"),
        SETTINGS_SAVED: h._("Language settings successfully saved."),
        REPORT_LANGUAGE_THANKS: h._("Thank you for letting us know about this error. Your feedback improves translation for everyone on Facebook."),
        LANGUAGE_SETTINGS_REMINDER: h._("You can change this at any time in your language settings."),
        ADD_TRANSLATION: h._("Add Translation"),
        CROWDSOURCING_TARGET_DIALECT_DIALOG: h._("Settings"),
        TRANSLATE_ALL_TEXT: h._("Translate all comments"),
        NUM_TRANSLATIONS_TEXT: h._("translations"),
        getTranslatedFromTo: function j(k, l) {
            return h._("Translated from {source language} to {target language}", [h.param('source language', k), h.param('target language', l)]);
        },
        getTranslatedFrom: function j(k) {
            return h._("Translated from {source language}", [h.param('source language', k)]);
        },
        getReportLanguageDialogBody: function j(k) {
            return h._("Are you sure this post was not in {language}?", [h.param('language', k)]);
        },
        getReportLanguage: function j(k) {
            return h._("Post was not in {language}", [h.param('language', k)]);
        },
        getReportLanguageSelector: function j(k) {
            return h._("This post was actually in: {language selector}", [h.param('language selector', k)]);
        },
        getNeverTranslate: function j(k) {
            return h._("Never translate {language}", [h.param('language', k)]);
        },
        getNeverTranslateDialog: function j(k) {
            return h._("Are you sure? Posts in {language} won't be translated for you.", [h.param('language', k)]);
        },
        getDisableAutoTranslate: function j(k) {
            return h._("Disable automatic translation for {dialect}", [h.param('dialect', k)]);
        },
        getDisableAutoTranslateDialog: function j(k) {
            return h._("Are you sure? Posts in {dialect} won't be automatically translated for you.", [h.param('dialect', k)]);
        },
        getUserFeedbackTitleForScore: function j(k) {
            switch (k) {
                case c('TranslationRating').VERY_BAD:
                    return h._("Very bad.");
                case c('TranslationRating').BAD:
                    return h._("Bad.");
                case c('TranslationRating').OK:
                    return h._("OK.");
                case c('TranslationRating').GOOD:
                    return h._("Good.");
                case c('TranslationRating').VERY_GOOD:
                    return h._("Very good.");
                default:
                    return null;
            }
        },
        getUserFeedbackDescriptionForScore: function j(k) {
            switch (k) {
                case c('TranslationRating').VERY_BAD:
                    return h._("I can't understand anything.");
                case c('TranslationRating').BAD:
                    return h._("I can't understand most of this.");
                case c('TranslationRating').OK:
                    return h._("I can understand enough of this.");
                case c('TranslationRating').GOOD:
                    return h._("I can understand most of this.");
                case c('TranslationRating').VERY_GOOD:
                    return h._("I can understand everything.");
                default:
                    return null;
            }
        }
...
__d('CacheStorage', ['ErrorUtils', 'EventListener', 'ExecutionEnvironment', 'FBJSON', 'WebStorage'], (function a(b, c, d, e, f, g) {
    var h, i, j, k;
    if (c.__markCompiled) c.__markCompiled();
    var l = {
            memory: s,
    ...
    p.prototype.keys = function() {
        'use strict';
        var u = [];
        for (var v = 0; v < this._store.length; v++) u.push(this._store.key(v));
        return u;
    };
    ...
    s.prototype.get = function(u) {
        'use strict';
        if (this._store[u] === undefined) return null;
        return this._store[u];
    };
    s.prototype.set = function(u, v) {
        'use strict';
        this._store[u] = v;
    };
    s.prototype.remove = function(u) {
        'use strict';
        if (u in this._store) delete this._store[u];
    };
    ...
    function t(u, v) {
        ...
        if (u)
            if (!l[u] || !l[u].available()) {
                c('ExecutionEnvironment').canUseDOM;
                this._backend = new s();
            } else this._backend = new l[u]();
        var y = this.useBrowserStorage();
        if (y) c('EventListener').listen(window, 'storage', this._onBrowserValueChanged.bind(this));
        var z = y ? this._backend.getStore().getItem(o) : this._backend.getStore()[o];
        if (z !== n) this.clear();
    }
    t.prototype.useBrowserStorage = function() {
        'use strict';
        return this._backend.getStore() === c('WebStorage').getLocalStorage() || this._backend.getStore() === c('WebStorage').getSessionStorage();
    };
    t.prototype.addValueChangeCallback = function(u) {
        'use strict';
    ...
    t.prototype._onBrowserValueChanged = function(u) {
        'use strict';
        if (this._changeCallbacks && String(u.key).startsWith(this._key_prefix)) this._changeCallbacks.forEach(function(v) {
    ...
    t.prototype.keys = function() {
        'use strict';
        var u = [];
        c('ErrorUtils').guard(function() {
            if (this._backend) {
                var v = this._backend.keys(),
                    w = this._key_prefix.length;
                for (var x = 0; x < v.length; x++)
                    if (v[x].substr(0, w) == this._key_prefix) u.push(v[x].substr(w));
            }
        }.bind(this), 'CacheStorage')();
        return u;
    };
    t.prototype.set = function(u, v, w) {
        'use strict';
        if (this._backend) {
            var x;
            if (typeof v == 'string') {
                ...
                x = c('FBJSON').stringify(x);
            } else x = c('FBJSON').stringify(v);
            var y = this._backend,
    ...
    t.prototype._evictCacheEntries = function() {
        'use strict';
        var u = [],
            v = this._backend;
        v.keys().forEach(function(x) {
            ...
            if (t._hasMagicPrefix(y)) return;
            try {
                y = c('FBJSON').parse(y, f.id);
            } catch (z) {
                v.remove(x);
                return;
            }
            if (y && y.__t !== undefined && y.__v !== undefined) u.push([x, y.__t]);
        });
        u.sort(function(x, y) {
            return x[1] - y[1];
        });
        for (var w = 0; w < Math.ceil(u.length / 2); w++) v.remove(u[w][0]);
    };
    t.prototype.get = function(u, v) {
        'use strict';
        var w;
        if (this._backend) {
            ...
            if (w !== null) {
                if (t._hasMagicPrefix(w)) {
                    ...
                    w = c('FBJSON').parse(w, f.id);
                    if (w && w.__t !== undefined && w.__v !== undefined) w = w.__v;
                } catch (x) {
                    w = undefined;
                }
            } else w = undefined;
    ...
    t.prototype.remove = function(u) {
        'use strict';
        if (this._backend) c('ErrorUtils').applyWithGuard(this._backend.remove, this._backend, [this._key_prefix + u], null, 'CacheStorage:remove');
    };
    t.prototype.clear = function() {
        'use strict';
        if (this._backend) {
            c('ErrorUtils').applyWithGuard(this._backend.clear, this._backend, null, null, null, 'CacheStorage:clear');
...
__d('MarauderLogger', ['Banzai', 'CacheStorage', 'MarauderConfig'], (function a(b, c, d, e, f, g) {
    ...
    function ba() {
        ...
        var ra = Date.now();
        if (!v || ra - j > aa()) {
            v = ra.toString(16) + '-' + (~~(Math.random() * 16777215)).toString(16);
            ia().set(m, v);
        }
        return v;
    }
    ...
    function ha(ra) {
        ...
        if (p) ra.push(ea('counters', null, n));
        var sa = ra[0].name === 'time_spent_bit_array' && c('Banzai').isEnabled('vital_navigations'),
        ...
        if (ua && Math.random() < .01) ra.push(ea('device_info', null, ca()));
        if (s !== null)
            for (var va = 0; va < ra.length; va++) {
                var wa = ra[va];
                if (wa.uuid === null || wa.uuid === undefined) wa.uuid = s;
            }
        var xa = {
...
__d("XReactComposerLoggingODSController", ["XController"], (function a(b, c, d, e, f, g) {
    c.__markCompiled && c.__markCompiled();
    f.exports = c("XController").create("\/react_composer\/logging\/ods\/", {
        attachment_type: {
            type: "String"
        },
        composer_type: {
